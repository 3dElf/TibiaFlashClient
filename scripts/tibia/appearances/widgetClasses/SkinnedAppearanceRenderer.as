package tibia.appearances.widgetClasses
{
   ...
   public class SkinnedAppearanceRenderer extends UIComponent
   {
      ...
      private static function initializeStyle() : void
      {
         ...
         {
            SkinnedAppearanceRenderer.backgroundImage = undefined;
            SkinnedAppearanceRenderer.overlayDisabledImage = undefined;
            SkinnedAppearanceRenderer.overlayHighlightImage = undefined;
            SkinnedAppearanceRenderer.paddingBottom = 2;
            SkinnedAppearanceRenderer.paddingLeft = 2;
            SkinnedAppearanceRenderer.paddingRight = 2;
            SkinnedAppearanceRenderer.paddingTop = 2;
         };
