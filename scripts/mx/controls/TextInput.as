package mx.controls
{
   ...
   public class TextInput extends UIComponent implements IDataRenderer, IDropInListItemRenderer, IFocusManagerComponent, IIMESupport, IListItemRenderer, IFontContextComponent
   {
      ...
      override protected function focusOutHandler(param1:FocusEvent) : void
      {
         ...
         if(_imeMode != null && Boolean(_editable))
         {
      ...
      override protected function measure() : void
      {
         ...
         super.measure();
         var _loc1_:EdgeMetrics = Boolean(border) && border is IRectangularBorder?IRectangularBorder(border).borderMetrics:EdgeMetrics.EMPTY;
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         switch(param1.keyCode)
         {
            case Keyboard.ENTER:
               ...
               if(Boolean(textChanged) || Boolean(htmlTextChanged))
               {
                  validateNow();
               }
         }
      ...
      override protected function focusInHandler(param1:FocusEvent) : void
      {
         ...
         if(Boolean(editable) && Boolean(fm))
         {
            fm.showFocusIndicator = true;
            if(Boolean(textField.selectable) && _selectionBeginIndex == _selectionEndIndex)
            {
      ...
      override public function get baselinePosition() : Number
      {
         ...
         if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_3_0)
         {
            ...
            return (Boolean(border) && border is IRectangularBorder?IRectangularBorder(border).borderMetrics.top:0) + measureText(_loc1_).ascent;
         }
      ...
      override protected function commitProperties() : void
      {
         ...
         if(Boolean(enabledChanged) || Boolean(editableChanged))
         {
            textField.type = Boolean(enabled) && Boolean(_editable)?TextFieldType.INPUT:TextFieldType.DYNAMIC;
            if(enabledChanged)
            {
         ...
         if(selectableChanged)
         {
            ...
            {
               textField.selectable = Boolean(enabled) && Boolean(_selectable);
            }
