package tibia.creatures.editBuddyWidgetClasses
{
   ...
   public class BuddyIconChooser extends HBox
   {
      ...
      private static function s_InitialiseStyle() : void
      {
         ...
         {
            BuddyIconChooser.horizontalGap = 2;
            BuddyIconChooser.verticalGap = 2;
            BuddyIconChooser.paddingBottom = 0;
            BuddyIconChooser.paddingLeft = 0;
            BuddyIconChooser.paddingRight = 0;
            BuddyIconChooser.paddingTop = 0;
         };
