package tibia.controls
{
   ...
   public class DynamicTabBar extends UIComponent
   {
      ...
      private static function s_InitializeStyle() : void
      {
         ...
         {
            DynamicTabBar.disabledSkin = null;
            DynamicTabBar.downSkin = null;
            DynamicTabBar.overSkin = null;
            DynamicTabBar.upSkin = null;
         };
         ...
         Decl.defaultFactory = function():void
         {
            DynamicTabBar.horizontalGap = 0;
            DynamicTabBar.paddingBottom = 0;
            DynamicTabBar.paddingLeft = 2;
            DynamicTabBar.paddingRight = 2;
            DynamicTabBar.paddingTop = 0;
            DynamicTabBar.dropIndicatorSkin = null;
            DynamicTabBar.scrollLeftButtonStyle = "defaultScrollLeftButtonStyle";
            DynamicTabBar.scrollRightButtonStyle = "defaultScrollRightButtonStyle";
            DynamicTabBar.dropDownButtonStyle = "defaultDropDownButtonStyle";
         };
      ...
      private function itemToToolTip(param1:Object) : String
      {
         ...
         if(param1 != null && this.m_ToolTipField != null && Boolean(param1.hasOwnProperty(this.m_ToolTipField)))
         {
      ...
      {
         if(this.m_UIDropIndicator != null && Boolean(contains(this.m_UIDropIndicator)))
         {
      ...
      override protected function measure() : void
      {
         ...
         while(_loc6_ < _loc7_)
         {
            ...
            if(Boolean(this.m_TabResize) && !isNaN(this.m_TabMinWidth))
            {
            ...
            if(Boolean(this.m_TabResize) && !isNaN(this.m_TabMaxWidth))
            {
      ...
      protected function onNavItemDragInit(param1:Event) : void
      {
         ...
         if(param1 != null && Boolean(this.m_DragEnabled))
         {
            _loc2_ = DynamicTab(param1.currentTarget);
            _loc3_ = getChildIndex(_loc2_);
            switch(param1.type)
      ...
      private function itemToIcon(param1:Object) : Class
      {
         ...
         if(param1 != null && this.m_IconField != null && Boolean(param1.hasOwnProperty(this.m_IconField)))
         {
      ...
      private function itemToLabel(param1:Object) : String
      {
         ...
         if(param1 != null && this.m_LabelField != null && Boolean(param1.hasOwnProperty(this.m_LabelField)))
         {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(this.m_DropDownPolicy != DROP_DOWN_OFF)
         {
            ...
            this.m_UIDropDownButton.visible = this.m_DropDownPolicy == DROP_DOWN_ON || Boolean(_loc11_);
         ...
         if(this.m_ScrollPolicy != ScrollPolicy.OFF)
         {
            ...
            this.m_UILeftButton.visible = this.m_ScrollPolicy == ScrollPolicy.ON || Boolean(_loc11_);
            ...
            this.m_UIRightButton.visible = this.m_ScrollPolicy == ScrollPolicy.ON || Boolean(_loc11_);
            _loc6_ = _loc6_ - _loc8_;
         }
         else
         {
         ...
         if(Boolean(this.m_TabResize) && _loc17_ > _loc18_ && _loc17_ > _loc6_)
         {
         ...
         if(this.m_ScrollPolicy != ScrollPolicy.OFF)
         {
            ...
            if(Boolean(this.m_UILeftButton.enabled) && !_loc21_)
            {
            ...
            if(Boolean(this.m_UIRightButton.enabled) && !_loc21_)
            {
         ...
         if(this.m_DropDownPolicy != DROP_DOWN_OFF)
         {
            this.m_UIDropDownButton.enabled = Boolean(this.m_UILeftButton.enabled) || Boolean(this.m_UIRightButton.enabled);
         }
         else
         {
