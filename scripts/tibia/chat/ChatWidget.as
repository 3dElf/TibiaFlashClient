package tibia.chat
{
   ...
   public class ChatWidget extends VBox
   {
      ...
      function onChatCopyPaste(param1:uint, param2:uint, param3:uint, param4:Boolean, param5:Boolean, param6:Boolean) : Boolean
      {
         ...
         if(Boolean(param4) || !param5 || Boolean(param6))
         {
      ...
      {
         if(Boolean(isNaN(param1)) && this.m_Options != null)
         {
      ...
      public function set volume(param1:int) : void
      {
         ...
         if(this.m_LeftChannel == null || this.m_LeftChannel.ID !== tibia.chat.ChatStorage.LOCAL_CHANNEL_ID && this.m_LeftChannel.ID !== tibia.chat.ChatStorage.SERVER_CHANNEL_ID && Boolean(this.m_LeftChannel.sendAllowed))
         {
            param1 = MessageMode.MESSAGE_SAY;
         }
      ...
      {
         if(Boolean(param4) || Boolean(param5) || Boolean(param6))
         {
      ...
      {
         var _loc2_:int = 0;
         if(this.m_LeftChannel != null && Boolean(this.m_LeftChannel.sendAllowed))
         {
         ...
         if(a_Event != null)
         {
            ...
            switch(a_Event.kind)
            {
               ...
               case CollectionEventKind.UPDATE:
                  ...
                  while(i < n)
                  {
                     if(Boolean(AutoSwitch) && (c = a_Event.items[i] as tibia.chat.Channel) != null)
                     {
                        this.leftChannel = c;
                     }
                     i++;
