package tibia.premium
{
    ...
    final public class PremiumMessage extends Object
    {
        ...
        public static const XP_BOOST:PremiumMessage = new PremiumMessage("LBL_XP_BOOST", ICON_XP_BOOST_BITMAP);
        public static const INVITE_PRIVCHAT:PremiumMessage = new PremiumMessage("LBL_INVITE_PRIVCHAT", ICON_INVITE_PRIVCHAT_BITMAP);
        ...
        public static const ACCESS_ARENAS:PremiumMessage = new PremiumMessage("LBL_ACCESS_ARENAS", ICON_ACCESS_ARENAS_BITMAP);
        ...
        public static const RENT_HOUSES:PremiumMessage = new PremiumMessage("LBL_RENT_HOUSES", ICON_RENT_HOUSES_BITMAP);
        ...
        public static const VIP_LIST:PremiumMessage = new PremiumMessage("LBL_VIP_LIST", ICON_VIP_LIST_BITMAP);
        public static const RIDE_MOUNTS:PremiumMessage = new PremiumMessage("LBL_RIDE_MOUNTS", ICON_RIDE_MOUNTS_BITMAP);
        ...
        public static const ALL_AREAS:PremiumMessage = new PremiumMessage("LBL_ALL_AREAS", ICON_MAP_BITMAP);
        private static const ICON_RENT_HOUSES_BITMAP:BitmapData = (new ICON_RENT_HOUSES_CLASS() as BitmapAsset).bitmapData;
        public static const RENEW_PREMIUM:PremiumMessage = new PremiumMessage("LBL_RENEW_PREMIUM", ICON_RENEW_PREMIUM_BITMAP);
        ...
        public static const MARKET:PremiumMessage = new PremiumMessage("LBL_MARKET", ICON_MARKET_BITMAP);
        ...
        public static const ALL_SPELLS:PremiumMessage = new PremiumMessage("LBL_ALL_SPELLS", ICON_SPELL_BITMAP);
        private static const ICON_SPELL_BITMAP:BitmapData = (new ICON_SPELL_CLASS() as BitmapAsset).bitmapData;
        public static const TRAVEL_FASTER:PremiumMessage = new PremiumMessage("LBL_TRAVEL_FASTER", ICON_TRAVEL_FASTER_BITMAP);
        ...
        public static const CLASS_PROMOTION:PremiumMessage = new PremiumMessage("LBL_CLASS_PROMOTION", ICON_CLASS_PROMOTION_BITMAP);
        public static const TRAIN_OFFLINE:PremiumMessage = new PremiumMessage("LBL_TRAIN_OFFLINE", ICON_TRAINING_BITMAP);
        ...
        public static const ALL_OUTFITS:PremiumMessage = new PremiumMessage("LBL_ALL_OUTFITS", ICON_ALL_OUTFITS_BITMAP);
        ...
        public static const DEPOT_SPACE:PremiumMessage = new PremiumMessage("LBL_DEPOT_SPACE", ICON_DEPOT_SPACE_BITMAP);
        private static const ICON_INVITE_PRIVCHAT_CLASS:Class = PremiumMessage_ICON_INVITE_PRIVCHAT_CLASS;
        public static const DEATH_PENALTY:PremiumMessage = new PremiumMessage("LBL_DEATH_PENALTY", ICON_DEATH_PENALTY_BITMAP);
