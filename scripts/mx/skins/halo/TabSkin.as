package mx.skins.halo
{
   ...
   public class TabSkin extends Border
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc13_:Boolean = parent != null && parent.parent != null && parent.parent.parent != null && Boolean(isTabNavigator(parent.parent.parent));
         var _loc14_:Number = 1;
         if(_loc13_)
         {
            _loc14_ = Object(parent.parent.parent).borderMetrics.top;
         }
         var _loc15_:Boolean = Boolean(_loc13_) && IStyleClient(parent.parent.parent).getStyle("borderStyle") != "none" && _loc14_ >= 0;
