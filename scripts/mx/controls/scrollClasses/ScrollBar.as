package mx.controls.scrollClasses
{
   ...
   public class ScrollBar extends UIComponent
   {
      ...
      public function set scrollPosition(param1:Number) : void
      {
         ...
         if(scrollThumb)
         {
            ...
            if(!isScrolling)
            {
               ...
               _loc3_ = _loc2_ == 0 || Boolean(isNaN(_loc2_))?Number(0):Number((param1 - minScrollPosition) * (trackHeight - scrollThumb.height) / _loc2_ + trackY);
      ...
      public function setScrollProperties(param1:Number, param2:Number, param3:Number, param4:Number = 0) : void
      {
         ...
         if(this.maxScrollPosition - this.minScrollPosition > 0 && Boolean(enabled))
         {
