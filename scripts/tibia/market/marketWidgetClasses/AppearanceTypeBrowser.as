package tibia.market.marketWidgetClasses
{
   ...
   public class AppearanceTypeBrowser extends VBox implements tibia.market.marketWidgetClasses.IAppearanceTypeFilterEditor
   {
      ...
      public function get filterFunction() : Function
      {
         ...
         if(this.m_FilterFunction == null && Boolean(this.m_CreationComplete))
         {
            Market = null;
            if(this.filterDepot)
            {
            ...
            {
               return Boolean(param1 != null && param1.isMarket) && (Boolean(this["market"] == null || this["market"].getDepotAmount(param1))) && (this["filter"] == null || Boolean(this["filter"](param1)));
            });
         }
      ...
      private function mapToAppearanceTypes(param1:*) : AppearanceType
      {
         ...
         var _loc2_:int = -1;
         if(param1 is AppearanceType && Boolean(AppearanceType(param1).isMarket))
         {
