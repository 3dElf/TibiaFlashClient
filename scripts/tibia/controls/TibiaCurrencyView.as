package tibia.controls
{
    ...
    public class TibiaCurrencyView extends HBox
    {
        ...
        override protected function updateDisplayList(param1:Number, param2:Number) : void
        {
            ...
            {
                _loc_3 = this.m_UIBaseCurrencyText.getLineMetrics(0);
                ...
                this.m_UIBaseCurrencyText.graphics.moveTo(0, _loc_4);
                this.m_UIBaseCurrencyText.graphics.lineTo(_loc_3.width + 3, _loc_4);
            }
            return;
        }// end function
