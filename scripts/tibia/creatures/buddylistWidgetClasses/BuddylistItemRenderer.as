package tibia.creatures.buddylistWidgetClasses
{
   ...
   public class BuddylistItemRenderer extends UIComponent implements IListItemRenderer, IDataRenderer
   {
      ...
      private static function s_InitialiseStyle() : void
      {
         ...
         {
            BuddylistItemRenderer.paddingBottom = 0;
            BuddylistItemRenderer.paddingLeft = 0;
            BuddylistItemRenderer.paddingRight = 0;
            BuddylistItemRenderer.paddingTop = 0;
            BuddylistItemRenderer.horizontalGap = 2;
            BuddylistItemRenderer.verticalGap = 2;
      ...
      protected function onTimer(param1:TimerEvent) : void
      {
         ...
         if(param1 != null)
         {
            _loc2_ = this.m_Buddy != null && Boolean(this.m_Buddy.highlight);
            if(!_loc2_)
            {
