package tibia.options.configurationWidgetClasses
{
   ...
   public class HotkeyOptions extends VBox implements IOptionsEditor
   {
      ...
      {
         var _loc2_:Object = null;
         if(param1.itemRenderer != null && (_loc2_ = param1.itemRenderer.data) != null && Boolean(_loc2_.hasOwnProperty("action")))
         {
      ...
      override protected function commitProperties() : void
      {
         ...
         if(UncommittedMapping)
         {
            if(this.m_Index >= 0 && this.m_Index < this.m_MappingSets.length)
            {
               ...
               {
                  return param1 != null && Boolean(param1.hasOwnProperty("action")) && param1.action is IAction && !IAction(param1.action).hidden;
               };
               _List.refresh();
         ...
         if(UncommittedSelection)
         {
            ...
            if(this.m_UIMapping.dataProvider is IList)
            {
               ...
               while(i >= 0)
               {
                  ...
                  if(Item != null && Boolean(Item.hasOwnProperty("action")) && Item.action is IAction && Boolean(IAction(Item.action).equals(this.m_Action)))
                  {
                     break;
                  }
                  i--;
      ...
      {
         var _loc2_:Object = null;
         if(param1.columnIndex > 0 && param1.itemRenderer != null && (_loc2_ = param1.itemRenderer.data) != null && Boolean(_loc2_.hasOwnProperty("action")) && Boolean(_loc2_.hasOwnProperty("firstBinding")) && Boolean(_loc2_.hasOwnProperty("secondBinding")))
         {
      ...
      public function close(param1:Boolean = false) : void
      {
         ...
         if(this.m_Options != null && Boolean(param1))
         {
            _loc2_ = 0;
            _loc3_ = 0;
...
class CustomItemRenderer extends DataGridItemRenderer
{
   ...
   private function getRenderedBinding(param1:Object) : Binding
   {
      ...
      var _loc3_:String = null;
      if(param1 != null && (_loc2_ = listData as DataGridListData) != null && (_loc3_ = _loc2_.dataField) != null && Boolean(param1.hasOwnProperty(_loc3_)))
      {
