package tibia.chat
{
   ...
   public class NameFilterSet
   {
      ...
      public static function s_Unmarshall(param1:XML, param2:Number) : NameFilterSet
      {
         ...
         {
            log("NameFilterSet.s_Unmarshall: Missing attribute: id.");
            return null;
         }
      ...
      public function acceptMessage(param1:int, param2:String, param3:String) : Boolean
      {
         ...
         if(this.m_WhiteEnabled)
         {
            ...
            _loc5_ = null;
            if(Boolean(this.m_WhiteBuddies) && _loc4_ != null && (_loc5_ = _loc4_.getBuddySet(BuddySet.DEFAULT_SET)) != null && _loc5_.getBuddy(param2) != null)
            {
               return true;
            }
         ...
         {
            if(Boolean(this.m_BlackPrivate) && param1 == MessageMode.MESSAGE_PRIVATE_FROM)
            {
               return false;
            }
            if(Boolean(this.m_BlackYelling) && param1 == MessageMode.MESSAGE_YELL)
            {
               return false;
            }
