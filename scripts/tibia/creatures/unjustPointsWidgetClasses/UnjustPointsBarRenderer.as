package tibia.creatures.unjustPointsWidgetClasses
{
   ...
   public class UnjustPointsBarRenderer extends UIComponent implements IDataRenderer
   {
      ...
      private static function s_InitialiseStyle() : void
      {
         ...
         {
            UnjustPointsBarRenderer.color = 13684944;
            UnjustPointsBarRenderer.paddingBottom = 2;
            UnjustPointsBarRenderer.paddingLeft = 2;
            UnjustPointsBarRenderer.paddingRight = 2;
            UnjustPointsBarRenderer.paddingTop = 2;
            UnjustPointsBarRenderer.horizontalGap = 2;
            UnjustPointsBarRenderer.verticalGap = 2;
            UnjustPointsBarRenderer.pointbarHeight = 4;
            UnjustPointsBarRenderer.pointbarWidth = 70;
            UnjustPointsBarRenderer.pointbarLeft = 22;
            UnjustPointsBarRenderer.pointbarTop = 2;
         };
