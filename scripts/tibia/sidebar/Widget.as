   ...
   public class Widget extends EventDispatcher
   {
      ...
      public function set height(param1:Number) : void
      {
         ...
         if(this.m_Height != param1)
         {
            ...
            if(Boolean(_loc3_.cancelable) && Boolean(_loc3_.isDefaultPrevented()))
            {
      ...
      {
         if(Boolean(param1) && this.m_ViewInstance == null)
         {
      ...
      public function unmarshall(param1:XML, param2:int) : void
      {
         ...
         var _loc3_:XMLList = null;
         if(Boolean(this.collapsible) && (_loc3_ = param1.@collapsed) != null && _loc3_.length() == 1)
         {
            this.collapsed = _loc3_[0].toString() == "true";
         }
         if(Boolean(this.resizable) && (_loc3_ = param1.@height) != null && _loc3_.length() == 1)
         {
