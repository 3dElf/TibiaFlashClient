package mx.controls
{
   ...
   public class ButtonBar extends NavBar implements IFocusManagerComponent
   {
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         if(Boolean(_loc2_) || param1 == buttonStyleNameProp || param1 == firstButtonStyleNameProp || param1 == lastButtonStyleNameProp)
         {
            resetNavItems();
         }
         ...
         else if(Boolean(StyleManager.isInheritingStyle(param1)) && Boolean(StyleManager.isSizeInvalidatingStyle(param1)))
         {
            recalcButtonWidths = recalcButtonHeights = true;
         }
      }
      ...
      mx_internal function drawButtonFocus(param1:int, param2:Boolean) : void
      {
         ...
         if(numChildren > 0 && param1 < numChildren)
         {
            ...
            _loc3_.drawFocus(Boolean(param2) && Boolean(focusManager.showFocusIndicator));
            if(param2)
            {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         var _loc12_:Number = Boolean(_loc3_) && numChildren > 0?Number(_loc10_ * (_loc9_ - 1)):Number(0);
         var _loc13_:Number = Boolean(_loc4_) && numChildren > 0?Number(_loc11_ * (_loc9_ - 1)):Number(0);
         ...
         if(recalcButtonWidths)
         {
            ...
            if(Boolean(isNaN(_loc5_)) && Boolean(_loc4_))
            {
               _loc5_ = _loc14_;
            }
         ...
         if(recalcButtonHeights)
         {
            ...
            if(Boolean(isNaN(_loc7_)) && Boolean(_loc3_))
            {
               _loc7_ = _loc15_;
            }
            _loc18_ = _loc15_ - (calcFullHeight() - _loc13_);
            _loc25_ = 0;
            if(_loc18_ != 0 && Boolean(_loc4_))
            {
               _loc16_ = 0;
               while(_loc16_ < _loc9_)
               {
      ...
      {
         if(Boolean(initialized) && param1 != direction)
         {
