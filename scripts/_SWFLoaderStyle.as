package
{
   ...
   public class _SWFLoaderStyle
   {
      ...
      private static var _embed_css_Assets_swf___brokenImage_1967925383:Class = _SWFLoaderStyle__embed_css_Assets_swf___brokenImage_1967925383;
      ...
      public static function init(param1:IFlexModuleFactory) : void
      {
         ...
         if(style.defaultFactory == null)
         {
            style.defaultFactory = function():void
            {
               ...
               _SWFLoaderStyle.brokenImageSkin = _embed_css_Assets_swf___brokenImage_1967925383;
