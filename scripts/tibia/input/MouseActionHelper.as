   ...
   public class MouseActionHelper
   {
      ...
      public static function resolveActionForAppearanceOrCreature(param1:uint, param2:*, param3:Vector.<uint>) : uint
      {
         ...
         if(param2 is AppearanceInstance)
         {
            ...
            if(Boolean(_loc6_.type.isCreature) && _loc6_ is ObjectInstance)
            {
         ...
         if(_loc4_ == ACTION_SMARTCLICK)
         {
            ...
            else if(_loc6_ != null && Boolean(_loc6_.type.isUsable))
            {
         ...
         {
            _loc4_ = ACTION_USE;
            if(_loc6_ != null && Boolean(_loc6_.type.isContainer))
            {
               _loc4_ = ACTION_OPEN;
            }
         }
         if(_loc4_ == ACTION_ATTACK_OR_TALK)
         {
            ...
            if(_loc5_ != null && Boolean(_loc5_.isNPC))
            {
               _loc4_ = ACTION_TALK;
            }
         }
