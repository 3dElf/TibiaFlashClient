   ...
   public class SelectOutfitWidget extends PopUpBase
   {
      ...
      protected function onPlayerAddonsChange(param1:Event) : void
      {
         ...
         if(param1 != null)
         {
            ...
            while(_loc3_ >= 0)
            {
               if(Boolean(this.m_UIPlayerAddons[_loc3_].enabled) && Boolean(this.m_UIPlayerAddons[_loc3_].selected))
               {
      ...
      override protected function createChildren() : void
      {
         ...
         if(!this.m_UIConstructed)
         {
            ...
            _loc1_.addChild(this.m_UIPlayerOutift);
            ...
            _loc1_.addChild(this.m_UIMountOutfit);
            addChild(_loc1_);
            _loc1_ = new HBox();
            _loc1_.percentHeight = NaN;
            _loc1_.percentWidth = 100;
            _loc2_ = 0;
            while(_loc2_ < this.m_UIPlayerAddons.length)
            {
               this.m_UIPlayerAddons[_loc2_] = new CheckBox();
               this.m_UIPlayerAddons[_loc2_].data = 1 << _loc2_;
               this.m_UIPlayerAddons[_loc2_].label = resourceManager.getString(BUNDLE,"CHECK_OUTFIT_ADDON",[_loc2_ + 1]);
               this.m_UIPlayerAddons[_loc2_].percentHeight = NaN;
               this.m_UIPlayerAddons[_loc2_].percentWidth = 33;
               this.m_UIPlayerAddons[_loc2_].styleName = this;
               this.m_UIPlayerAddons[_loc2_].addEventListener(Event.CHANGE,this.onPlayerAddonsChange);
               _loc1_.addChild(this.m_UIPlayerAddons[_loc2_]);
               _loc2_++;
            }
            addChild(_loc1_);
            ...
            _loc2_ = 0;
            while(_loc2_ < this.m_UIPlayerColours.length)
            {
               _loc1_ = new HBox();
               _loc1_.label = resourceManager.getString(BUNDLE,BODY_PARTS[_loc2_]);
               _loc1_.percentHeight = 100;
               _loc1_.percentWidth = 100;
               _loc1_.styleName = "selectOutfitTabContainer";
               this.m_UIPlayerColours[_loc2_] = new OutfitColourSelector();
               this.m_UIPlayerColours[_loc2_].HSI = this.m_PlayerColours[_loc2_];
               this.m_UIPlayerColours[_loc2_].addEventListener(PropertyChangeEvent.PROPERTY_CHANGE,this.onPlayerColoursChange);
               _loc1_.addChild(this.m_UIPlayerColours[_loc2_]);
