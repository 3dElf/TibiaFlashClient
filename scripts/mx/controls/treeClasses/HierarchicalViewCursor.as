package mx.controls.treeClasses
{
   ...
   public class HierarchicalViewCursor extends EventDispatcher implements IViewCursor
   {
      ...
      private function isNodeBefore(param1:Object, param2:Object) : Boolean
      {
         ...
         while(Boolean(_loc7_.length) && Boolean(_loc8_.length))
         {
            ...
            if(_loc9_ != _loc10_)
            {
               ...
               if(_loc6_ != null && Boolean(dataDescriptor.isBranch(_loc6_,model)) && Boolean(dataDescriptor.hasChildren(_loc6_,model)))
               {
      ...
      public function moveToLast() : void
      {
         ...
         while(Boolean(openNodes[itemToUID(_loc2_)]) && Boolean(dataDescriptor.isBranch(_loc2_,model)) && Boolean(dataDescriptor.hasChildren(_loc2_,model)))
         {
            _loc3_ = childNodes;
      ...
      public function movePrevious() : Boolean
      {
         ...
         if(Boolean(parentNodes) && parentNodes.length > 0)
         {
            if(currentChildIndex == 0)
            {
               ...
               if(grandParent != null && Boolean(dataDescriptor.isBranch(grandParent,model)) && Boolean(dataDescriptor.hasChildren(grandParent,model)))
               {
         ...
         while(Boolean(openNodes[itemToUID(currentNode)]) && Boolean(dataDescriptor.isBranch(currentNode,model)) && Boolean(dataDescriptor.hasChildren(currentNode,model)))
         {
      ...
      public function moveNext() : Boolean
      {
         ...
         if(Boolean(openNodes[uid]) && Boolean(dataDescriptor.isBranch(currentNode,model)) && Boolean(dataDescriptor.hasChildren(currentNode,model)))
         {
            previousChildNodes = childNodes;
            childNodes = dataDescriptor.getChildren(currentNode,model);
            if(childNodes.length > 0)
