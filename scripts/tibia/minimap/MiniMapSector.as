package tibia.minimap
{
   ...
   public class MiniMapSector
   {
      ...
      private static function s_LoadSharedObjectInternal(param1:SharedObject, param2:MiniMapSector) : MiniMapSector
      {
         ...
         if(a_SharedObject != null && (Data = a_SharedObject.data) != null && Boolean(Data.hasOwnProperty("version")) && Boolean(Data.hasOwnProperty("sectorX")) && Boolean(Data.hasOwnProperty("sectorY")) && Boolean(Data.hasOwnProperty("sectorZ")) && Boolean(Data.hasOwnProperty("bitmapDataBytes")) && Boolean(Data.hasOwnProperty("cost")) && Boolean(Data.hasOwnProperty("minCost")) && Boolean(Data.hasOwnProperty("mark")))
         {
      ...
      function loadSharedObject() : void
      {
         ...
         try
         {
            ...
            _SharedObject = null;
            if(Boolean(SharedObjectManager.s_SharedObjectsAvailable()) && (_SharedObjectManager = SharedObjectManager.s_GetInstance()) != null && (_SharedObject = _SharedObjectManager.getLocal(Name,true,true)) != null)
            {
      ...
      function saveSharedObject(param1:Boolean) : void
      {
         ...
         try
         {
            ...
            _SharedObjectManager = null;
            _SharedObject = null;
            if(Boolean(this.m_Dirty) && Boolean(SharedObjectManager.s_SharedObjectsAvailable()) && (_SharedObjectManager = SharedObjectManager.s_GetInstance()) != null && (_SharedObject = _SharedObjectManager.getLocal(Name,true,true)) != null)
            {
