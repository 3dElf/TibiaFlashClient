package tibia.magic
{
    ...
    public class SpellStorage extends Object
    {
        ...
        private function setDelay(param1:Vector.<SpellDelay>, param2:int, param3:Number, param4:Number) : Object
        {
            ...
            if (_loc_8 == null || _loc_8.ID != param2)
            {
                _loc_8 = new SpellDelay(param2, 0, 0);
                param1.splice(_loc_5, 0, _loc_8);
            }
            _loc_8.start = param3;
            _loc_8.end = param3 + param4;
            return _loc_8;
        }// end function
        ...
        {
            var _loc_3:* = null;
            var _loc_2:* = getSpell(param1);
            if (_loc_2 != null)
            {
                _loc_3 = this.getDelay(this.m_SpellDelay, _loc_2.ID);
                _loc_3 = Delay.merge(_loc_3, this.getDelay(this.m_SpellGroupDelay, _loc_2.groupPrimary));
                _loc_3 = Delay.merge(_loc_3, this.getDelay(this.m_SpellGroupDelay, _loc_2.groupSecondary));
                return _loc_3;
            }
            return null;
        }// end function
        ...
        {
            var _loc_3:* = null;
            var _loc_2:* = getRune(param1);
            if (_loc_2 != null)
            {
                _loc_3 = Delay.merge(this.getDelay(this.m_SpellGroupDelay, _loc_2.groupPrimary), this.getDelay(this.m_SpellGroupDelay, _loc_2.groupSecondary));
                return _loc_3;
            }
            return null;
        }// end function
        ...
        {
            var _loc_2:* = this.getDelay(this.m_SpellGroupDelay, param1);
            if (_loc_2 != null)
            {
                return _loc_2.clone();
            }
        ...
        public static function getSpell(param1:int) : Spell
        {
            var _loc_5:* = null;
            var _loc_2:* = 0;
            var _loc_3:* = SPELLS.length - 1;
            var _loc_4:* = 0;
            while (_loc_2 <= _loc_3)
            {
                
                _loc_4 = _loc_2 + _loc_3 >>> 1;
                _loc_5 = SPELLS[_loc_4];
                if (_loc_5.ID < param1)
                {
                    _loc_2 = _loc_4 + 1;
                    continue;
