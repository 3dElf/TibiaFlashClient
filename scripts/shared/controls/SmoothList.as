package shared.controls
{
   ...
   public class SmoothList extends ScrollControlBase
   {
      ...
      private static function s_InitializeStyle() : void
      {
         ...
         {
            SmoothList.borderSkin = undefined;
            SmoothList.itemBackgroundColors = undefined;
            SmoothList.itemBackgroundAlphas = undefined;
            SmoothList.itemHorizontalGap = 0;
            SmoothList.itemVerticalGap = 2;
            SmoothList.itemSelectionColor = 16711680;
            SmoothList.itemSelectionAlpha = 1;
            SmoothList.itemRendererStyle = undefined;
            SmoothList.paddingBottom = 0;
            SmoothList.paddingLeft = 0;
            SmoothList.paddingRight = 0;
            SmoothList.paddingTop = 0;
         };
      ...
      override protected function mouseWheelHandler(param1:MouseEvent) : void
      {
         ...
         if(verticalScrollBar != null && Boolean(verticalScrollBar.visible))
         {
      ...
      {
         if(Boolean(this.m_Selectable) && !param1)
         {
      ...
      {
         if(Boolean(this.m_Selectable) && this.m_DataProvider != null && this.m_SelectedIndex >= 0 && this.m_SelectedIndex < this.m_DataProvider.length)
         {
      ...
      {
         if(Boolean(this.m_Selectable) && this.m_SelectedIndex != param1)
         {
