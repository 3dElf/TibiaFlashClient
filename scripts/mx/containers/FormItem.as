package mx.containers
{
   ...
   public class FormItem extends Container
   {
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         if(Boolean(_loc2_) || param1 == "labelStyleName")
         {
            if(labelObj)
            {
      ...
      private function calcNumColumns(param1:Number) : int
      {
         ...
         if(Boolean(isNaN(param1)) || _loc2_ <= param1)
         {
            return _loc5_;
         }
         if(_loc3_ * 2 <= param1)
      ...
      private function updateDisplayListHorizontalChildren(param1:Number, param2:Number) : void
      {
         ...
         var _loc22_:int = 0;
         if(_loc21_ != guessedNumColumns && Boolean(isNaN(explicitWidth)))
         {
      ...
      private function calculateLabelWidth() : Number
      {
         ...
         if(Boolean(isNaN(_loc1_)) && parent is Form)
         {
