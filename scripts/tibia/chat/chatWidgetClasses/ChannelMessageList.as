package tibia.chat.chatWidgetClasses
{
   ...
   public class ChannelMessageList extends SmoothList
   {
      ...
      {
         if(this.m_UnreadEffect != null && Boolean(this.m_UnreadEffect.isPlaying))
         {
            this.m_UnreadEffect.end();
         }
         if(Tibia.s_GetChatWidget() != null && Tibia.s_GetChatWidget().tabBar != null && Tibia.s_GetChatWidget().tabBar.selectedTab != null)
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         else if(_loc3_ > 0 && Boolean(this.m_StopScrollingOnLargeBlocks) && this.m_LastMarkerLineCount < _loc3_ && Boolean(m_FollowTail))
         {
            _loc4_ = -1;
            _loc5_ = _loc3_ - 1;
            while(_loc5_ >= 0)
         ...
         if(Boolean(m_FollowTail) || m_LastVisibleItem == _loc3_ - 1)
         {
            this.stopIndicatorForUnreadText();
         }
         this.updateSelectedText();
