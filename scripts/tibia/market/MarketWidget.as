      ...
      public function mergeBrowseOffers(param1:int, param2:Array) : void
      {
         ...
         if(param1 == s_BrowseTypeID)
         {
            ...
            while(_loc5_ < _loc4_)
            {
               ...
               if(_loc3_ == null || Boolean(_loc3_.isLessThan(_loc6_)))
               {
               ...
               else
               {
                  ...
                  while(_loc7_ < _loc8_ && Boolean(Offer(this.m_BrowseOffers[_loc7_]).isLessThan(_loc6_)))
                  {
                     _loc7_++;
                  }
                  if(_loc7_ < _loc8_ && Boolean(Offer(this.m_BrowseOffers[_loc7_]).isEqual(_loc6_)))
                  {
                     if(_loc6_.amount == 0)
                     {
