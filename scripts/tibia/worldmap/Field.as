package tibia.worldmap
{
   ...
   public class Field
   {
      ...
      public function updateObjectsCache() : void
      {
         ...
         _loc1_ = 0;
         while(_loc1_ < this.m_ObjectsCount && (Boolean((_loc3_ = this.m_ObjectsNetwork[_loc1_].type).isBank) || Boolean(_loc3_.isClip) || Boolean(_loc3_.isBottom)))
         {
         ...
         while(_loc1_ < this.m_ObjectsCount)
         {
            ...
            else if(Boolean(_loc3_.isHookEast) || Boolean(_loc3_.isHookSouth))
            {
               _loc5_ = _loc3_;
            }
            _loc1_++;
         ...
         if(_loc4_ != null)
         {
            if(_loc5_ != null && Boolean(_loc5_.isHookEast))
            {
      ...
      public function getTopLookObject(param1:Object = null) : int
      {
         ...
         while(_loc4_ < this.m_ObjectsCount)
         {
            ...
            if(!(_loc2_ != -1 && Boolean(_loc5_.isIgnoreLook)))
            {
               _loc2_ = _loc4_;
      ...
      public function getTopUseObject(param1:Object = null) : int
      {
         ...
         if(this.m_ObjectsCount > 0)
         {
            ...
            while(_loc2_ > 0 && ((_loc4_ = this.m_ObjectsNetwork[_loc2_].type).ID == AppearanceInstance.CREATURE || Boolean(_loc4_.isLiquidPool)))
            {
               _loc2_--;
            }
      ...
      public function getTopMultiUseObject(param1:Object = null) : int
      {
         ...
         if(this.m_ObjectsCount > 0)
         {
            ...
            if(_loc2_ > 0 && !(_loc4_ = this.m_ObjectsNetwork[_loc2_].type).isForceUse && Boolean(_loc4_.isLiquidPool))
            {
               _loc2_--;
            }
            _loc3_ = this.m_ObjectsNetwork[_loc2_];
      ...
      public function getTopMoveObject(param1:Object = null) : int
      {
         ...
         if(this.m_ObjectsCount > 0)
         {
            ...
            if(_loc2_ > 0 && Boolean(this.m_ObjectsNetwork[_loc2_].type.isUnmoveable))
            {
               _loc2_--;
            }
            _loc3_ = this.m_ObjectsNetwork[_loc2_];
