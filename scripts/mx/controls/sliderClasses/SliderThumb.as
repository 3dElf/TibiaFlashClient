package mx.controls.sliderClasses
{
   ...
   public class SliderThumb extends Button
   {
      ...
      override protected function keyDownHandler(param1:KeyboardEvent) : void
      {
         ...
         if(param1.keyCode == Keyboard.DOWN && !_loc5_ || param1.keyCode == Keyboard.LEFT && Boolean(_loc5_))
         {
            _loc6_ = _loc3_ - _loc4_;
         }
         else if(param1.keyCode == Keyboard.UP && !_loc5_ || param1.keyCode == Keyboard.RIGHT && Boolean(_loc5_))
         {
            _loc6_ = _loc3_ + _loc4_;
         }
         else if(param1.keyCode == Keyboard.PAGE_DOWN && !_loc5_ || param1.keyCode == Keyboard.HOME && Boolean(_loc5_))
         {
            _loc6_ = Slider(owner).getXFromValue(Slider(owner).minimum);
         }
         else if(param1.keyCode == Keyboard.PAGE_UP && !_loc5_ || param1.keyCode == Keyboard.END && Boolean(_loc5_))
         {
