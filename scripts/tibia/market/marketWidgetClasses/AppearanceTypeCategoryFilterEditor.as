package tibia.market.marketWidgetClasses
{
   ...
   class AppearanceTypeCategoryFilterEditor extends VBox implements IAppearanceTypeFilterEditor
   {
      ...
      private function onCategoryCange(param1:Event) : void
      {
         ...
         if(param1 != null && (_loc2_ = param1.currentTarget as ComboBox) != null && Boolean(_loc2_.enabled))
         {
            switch(_loc2_)
            {
      ...
      public function adjustFilterFunction(param1:AppearanceType) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.filterLevel = Boolean(this.filterLevel) && _loc2_.level >= param1.marketRestrictLevel;
            this.filterProfession = Boolean(this.filterProfession) && (1 << _loc2_.profession & param1.marketRestrictProfession) != 0;
         }
         else
         {
      ...
      public function get filterFunction() : Function
      {
         ...
         if(this.m_FilterFunction == null)
         {
            ...
            {
               return param1 != null && Boolean(param1.isMarket) && (this["category"] < 0 || this["category"] == param1.marketCategory) && (this["level"] < 0 || this["level"] >= param1.marketRestrictLevel) && (this["profession"] < 0 || param1.marketRestrictProfession == 0 || (this["profession"] & param1.marketRestrictProfession) != 0) && (this["bodyPosition"] < 0 || this["bodyPosition"] == param1.clothSlot);
            });
         }
