package tibia.chat.chatWidgetClasses
{
   ...
   public class ChannelTabBar extends DynamicTabBar
   {
      ...
      private function updateNavItemHighlight(param1:ChannelTab) : void
      {
         if(param1 != null)
         {
            if(Boolean(param1.highlight) && getStyle("navItemHighlightStyle") !== undefined)
            {
      ...
      {
         if(Boolean(this.isHighlightInRange(0,getFirstVisibleIndex())) && getStyle("scrollLeftButtonHighlightStyle") !== undefined)
         {
         ...
         if(Boolean(this.isHighlightInRange(getLastVisibleIndex(),getDataProviderLength())) && getStyle("scrollRightButtonHighlightStyle") !== undefined)
         {
