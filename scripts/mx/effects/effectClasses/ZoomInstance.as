package mx.effects.effectClasses
{
   ...
   public class ZoomInstance extends TweenEffectInstance
   {
      ...
      override public function play() : void
      {
         ...
         if(Boolean(isNaN(zoomWidthFrom)) && Boolean(isNaN(zoomWidthTo)) && Boolean(isNaN(zoomHeightFrom)) && Boolean(isNaN(zoomHeightTo)))
         {
            if(show)
            {
         ...
         {
            if(Boolean(isNaN(zoomWidthFrom)) && Boolean(isNaN(zoomWidthTo)))
            {
               zoomWidthFrom = zoomWidthTo = target.scaleX;
            }
            else if(Boolean(isNaN(zoomHeightFrom)) && Boolean(isNaN(zoomHeightTo)))
            {
