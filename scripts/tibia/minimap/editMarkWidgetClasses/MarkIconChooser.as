package tibia.minimap.editMarkWidgetClasses
{
   ...
   public class MarkIconChooser extends UIComponent
   {
      ...
      private static function s_InitializeStyle() : void
      {
         ...
         {
            MarkIconChooser.horizontalGap = 2;
            MarkIconChooser.verticalGap = 2;
            MarkIconChooser.paddingLeft = 0;
            MarkIconChooser.paddingRight = 0;
            MarkIconChooser.paddingTop = 0;
            MarkIconChooser.paddingBottom = 0;
         };
