   ...
   public class Binding
   {
      ...
      public function conflicts(param1:Binding) : Boolean
      {
         ...
         if(param1 != null)
         {
            ...
            if(Boolean(_loc2_) && !_loc3_ && (this.m_RawMod == 0 || this.m_RawMod == Keyboard.SHIFT) && !isControlKey(this.m_RawKey))
            {
               return true;
            }
            if(!_loc2_ && Boolean(_loc3_) && (param1.m_RawMod == 0 || param1.m_RawMod == Keyboard.SHIFT) && !isControlKey(param1.m_RawKey))
            {
               return true;
            }
         }
      ...
      {
         return (this.m_EventMask & param1) != 0 && this.m_RawKey == param2 && (this.m_RawMod != 0 || !param3 && !param4 && !param5) && (this.m_RawMod != Keyboard.ALTERNATE || Boolean(param3) && !param4 && !param5) && (this.m_RawMod != Keyboard.CONTROL || !param3 && Boolean(param4) && !param5) && (this.m_RawMod != Keyboard.SHIFT || !param3 && !param4 && Boolean(param5));
      }
      ...
      {
         return param1 != null && Boolean(this.m_Action.equals(param1.m_Action)) && this.m_EventMask == param1.m_EventMask && this.m_RawKey == param1.m_RawKey && this.m_RawMod == param1.m_RawMod && this.m_Editable == param1.m_Editable;
      }
   }
}
