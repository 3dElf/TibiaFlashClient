package shared.cryptography
{
   ...
   public class BigInt
   {
      ...
      static function s_ImplSub(param1:BigInt, param2:BigInt, param3:Boolean) : void
      {
         ...
         var _loc12_:uint = 0;
         var _loc13_:uint = 0;
         if(Boolean(param3) || param1.m_Positive == param2.m_Positive)
         {
            _loc4_ = param1;
            _loc5_ = param2;
            _loc6_ = false;
      ...
      static function s_ImplDiv(param1:BigInt, param2:BigInt, param3:BigInt, param4:BigInt) : void
      {
         ...
         {
            param3.setZero();
            param3.m_Positive = Boolean(param1.m_Positive) && Boolean(param2.m_Positive) || !param1.m_Positive && !param2.m_Positive;
         }
         while(_loc7_ >= 0)
         {
            _loc8_ = 0;
      ...
      static function s_ImplMul(param1:BigInt, param2:BigInt) : void
      {
         ...
         param1.m_Positive = Boolean(param1.m_Positive) && Boolean(param2.m_Positive) || !param1.m_Positive && !param2.m_Positive;
      }
      ...
      {
         if(Boolean(this.m_Positive) && !param1.m_Positive)
         {
            return 1;
         }
         if(!this.m_Positive && Boolean(param1.m_Positive))
         {
            return -1;
         }
         if(this.m_Positive)
