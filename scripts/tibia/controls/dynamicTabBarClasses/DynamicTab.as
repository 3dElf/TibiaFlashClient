package tibia.controls.dynamicTabBarClasses
{
   ...
   public class DynamicTab extends Tab
   {
      ...
      private static function s_InitializeStyle() : void
      {
         ...
         {
            DynamicTab.disabledSkin = null;
            DynamicTab.downSkin = null;
            DynamicTab.overSkin = null;
            DynamicTab.upSkin = null;
         };
         ...
         Decl.defaultFactory = function():void
         {
            DynamicTab.closeButtonRight = 4;
            DynamicTab.closeButtonStyle = "defaultCloseButtonStyle";
            DynamicTab.closeButtonTop = 4;
         };
      ...
      {
         if(param1 != null && Boolean(enabled))
         {
         ...
         if(param1 != null)
         {
            switch(param1.type)
            {
               case MouseEvent.CLICK:
                  if(Boolean(enabled) && this.closePolicy != DynamicTabBar.CLOSE_NEVER && (this.closePolicy != DynamicTabBar.CLOSE_SELECTED || Boolean(selected)) && (this.closePolicy != DynamicTabBar.CLOSE_ROLLOVER || Boolean(this.m_IsRollOver)) && this.m_IsEnabled == enabled && this.m_IsSelected == selected)
                  {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(this.m_ClosePolicy == DynamicTabBar.CLOSE_ALWAYS || this.m_ClosePolicy == DynamicTabBar.CLOSE_SELECTED && Boolean(selected) || this.m_ClosePolicy == DynamicTabBar.CLOSE_ROLLOVER && Boolean(this.m_IsRollOver))
         {
