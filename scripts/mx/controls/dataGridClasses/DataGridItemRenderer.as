   ...
   public class DataGridItemRenderer extends UITextField implements IDataRenderer, IDropInListItemRenderer, ILayoutManagerClient, IListItemRenderer, IStyleClient
   {
      ...
      public function validateProperties() : void
      {
         ...
         if(_listData)
         {
            ...
            if(_loc3_)
            {
               if(!(_data is DataGridColumn) && (Boolean(textWidth > width || _loc2_.dataTipFunction || _loc2_.dataTipField || _loc1_.dataTipFunction) || Boolean(_loc1_.dataTipField)))
               {
      ...
      override public function setStyle(param1:String, param2:*) : void
      {
         ...
         if(_loc3_)
         {
            if(getStyle(param1) == param2 && Boolean(_loc4_))
            {
               return;
            }
            if(!styleDeclaration)
