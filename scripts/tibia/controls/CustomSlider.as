package tibia.controls
{
   ...
   public class CustomSlider extends Canvas
   {
      ...
      private static function s_InitialiseStyle() : void
      {
         ...
         {
            CustomSlider.horizontalAlign = "center";
            CustomSlider.verticalAlign = "middle";
            CustomSlider.horizontalGap = 2;
            CustomSlider.verticalGap = 2;
            CustomSlider.borderColor = 9542041;
            CustomSlider.dataTipOffset = 16;
            CustomSlider.dataTipPlacement = "top";
            CustomSlider.dataTipPrecision = 2;
            CustomSlider.labelOffset = -10;
            CustomSlider.showTrackHighlight = false;
            CustomSlider.slideDuration = 300;
            CustomSlider.thumbDisabledSkin = null;
            CustomSlider.thumbDownSkin = null;
            CustomSlider.thumbOffset = 0;
            CustomSlider.thumbOverSkin = null;
            CustomSlider.thumbSkin = SliderThumbSkin;
            CustomSlider.thumbUpSkin = null;
            CustomSlider.tickColor = 7305079;
            CustomSlider.tickLength = 3;
            CustomSlider.tickOffset = -6;
            CustomSlider.tickThickness = 1;
            CustomSlider.trackColors = [15198183,15198183];
            CustomSlider.trackHighlightSkin = SliderHighlightSkin;
            CustomSlider.trackSkin = SliderTrackSkin;
         };
      ...
      override protected function createChildren() : void
      {
         if(!this.m_UIConstructed)
         {
            ...
            this.m_UISlider.sliderThumbClass = CustomSlider;
      ...
      protected function onTrackDown(param1:MouseEvent) : void
      {
         ...
         if(Boolean(this.m_TrackClickEnabled) && param1 != null && param1.target == this.m_UISlider.mx_internal::getTrackHitArea())
         {
