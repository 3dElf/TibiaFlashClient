package mx.containers
{
   ...
   public class ViewStack extends Container implements IHistoryManagerClient
   {
      ...
      override mx_internal function setActualCreationPolicies(param1:String) : void
      {
         ...
         if(param1 == ContainerCreationPolicy.ALL && numChildren > 0)
         {
            ...
            while(_loc2_ < numChildren)
            {
               ...
               if(Boolean(_loc3_) && _loc3_.numChildrenCreated == -1)
               {
      ...
      private function instantiateSelectedChild() : void
      {
         ...
         if(Boolean(selectedChild) && selectedChild.numChildrenCreated == -1)
         {
            if(initialized)
            {
      ...
      override protected function measure() : void
      {
         ...
         _loc3_ = 0;
         _loc4_ = 0;
         if(Boolean(vsPreferredWidth) && !_resizeToContent)
         {
         ...
         if(Boolean(selectedChild) && Container(selectedChild).numChildrenCreated == -1)
         {
            return;
         }
         if(numChildren == 0)
      ...
      public function set selectedIndex(param1:int) : void
      {
         ...
         invalidateProperties();
         if(Boolean(historyManagementEnabled) && _selectedIndex != -1 && !bInLoadState)
         {
            bSaveState = true;
         }
