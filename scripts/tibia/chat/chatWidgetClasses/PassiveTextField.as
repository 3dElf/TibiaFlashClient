package tibia.chat.chatWidgetClasses
{
   ...
   public class PassiveTextField extends Label
   {
      ...
      {
         if(Boolean(enabled) && (param1 == InputEvent.KEY_DOWN || param1 == InputEvent.KEY_REPEAT))
         {
            switch(param3)
            {
      ...
      override protected function measure() : void
      {
         ...
         var _loc2_:TextLineMetrics = textField.getUITextFormat().measureText("gG");
      ...
      {
         var _loc2_:int = 0;
         if(param1 != null && Boolean(param1.buttonDown) && Boolean(enabled))
         {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         _loc7_.clear();
         if(Boolean(enabled) && this.m_CaretVisible > 0)
         {
            _loc8_ = getStyle("color");
            _loc9_ = getStyle("caretWidth");
            if(Boolean(isNaN(_loc9_)) || _loc9_ < 1)
            {
               _loc9_ = 1;
            }
      ...
      override protected function commitProperties() : void
      {
         ...
         if(this.m_UncommittedEnabled)
         {
            ...
            else if(this.m_CaretTimer != null && Boolean(this.m_CaretTimer.running))
            {
      ...
      {
         if(Boolean(enabled) && param1 == InputEvent.TEXT_INPUT)
         {
