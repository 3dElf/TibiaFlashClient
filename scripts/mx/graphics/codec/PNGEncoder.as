package mx.graphics.codec
{
    ...
    public class PNGEncoder extends Object implements IImageEncoder
    {
        ...
        private function internalEncode(param1:Object, param2:int, param3:int, param4:Boolean = true) : ByteArray
        {
            ...
            _loc_7.writeUnsignedInt(2303741511);
            ...
            _loc_8.writeByte(0);
            _loc_8.writeByte(0);
            writeChunk(_loc_7, 1229472850, _loc_8);
            ...
            _loc_9.compress();
            writeChunk(_loc_7, 1229209940, _loc_9);
            writeChunk(_loc_7, 1229278788, null);
            _loc_7.position = 0;
            return _loc_7;
        }// end function
        ...
        private function writeChunk(param1:ByteArray, param2:uint, param3:ByteArray) : void
        {
            ...
            while (_loc_8 < _loc_6)
            {
                ...
                _loc_7 = uint(crcTable[(_loc_7 ^ param1.readUnsignedByte()) & uint(255)] ^ uint(_loc_7 >>> 8));
                _loc_8 = _loc_8 + 1;
            }
