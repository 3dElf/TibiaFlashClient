package tibia.sessiondump.hints
{
    ...
    public class SessiondumpHintBase extends Object
    {
        ...
        public static function s_Unmarshall(param1:uint, param2:Object) : SessiondumpHintBase
        {
            ...
            {
                _loc_4 = param2[FIELD_TYPE] as String;
                switch(_loc_4)
                {
                    case SessiondumpHintCondition.TYPE:
                    {
                        _loc_3 = SessiondumpHintCondition.s_Unmarshall(param2);
                        break;
                    }
                    case SessiondumpHintSkipTo.TYPE:
                    {
                        _loc_3 = SessiondumpHintSkipTo.s_Unmarshall(param2);
                        break;
                    }
                    case SessiondumpHintSwitchChannel.TYPE:
                    {
                        _loc_3 = SessiondumpHintSwitchChannel.s_Unmarshall(param2);
                        break;
                    }
                    case SessiondumpHintTutorialProgress.TYPE:
                    {
                        _loc_3 = SessiondumpHintTutorialProgress.s_Unmarshall(param2);
                        break;
                    }
                    default:
                    {
                        _loc_3 = new SessiondumpHintBase;
                        break;
                        break;
                    }
                }
                _loc_3.m_Timestamp = param1;
            }
            return _loc_3;
        }// end function
