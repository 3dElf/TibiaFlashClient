package mx.effects
{
    ...
    public class CompositeEffect extends Effect
    {
        ...
        override protected function initInstance(param1:IEffectInstance) : void
        {
            ...
            if (children)
            {
                ...
                while (_loc_5 < _loc_4)
                {
                    ...
                    {
                        _loc_2.addChildSet(_loc_6.createInstances(_loc_3));
                    }
                    else
                    {
                        _loc_2.addChildSet(_loc_6.createInstances(_loc_6.targets));
                    }
                    _loc_5++;
                }
            }
        ...
        public function captureValues(param1:Array, param2:Boolean) : Array
        {
            var _loc_5:* = null;
        ...
        public function applyStartValues(param1:Array, param2:Array) : void
        {
            var _loc_5:* = null;
            var _loc_6:* = null;
            var _loc_3:* = children.length;
