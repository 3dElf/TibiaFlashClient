package tibia.market.marketWidgetClasses
{
   ...
   public class MarketOffersView extends MarketComponent
   {
      ...
      private function onAcceptClick(param1:MouseEvent) : void
      {
         ...
         if(param1 != null && (_loc2_ = param1.currentTarget == this.m_UIBuyAccept?this.m_UIBuyOffers.selectedItem as Offer:this.m_UISellOffers.selectedItem as Offer) != null && Boolean(this.checkAccept(_loc2_)))
         {
...
class CustomItemRenderer extends DataGridItemRenderer
{
   ...
   override public function set data(param1:Object) : void
   {
      ...
      if(data != param1)
      {
         ...
         if(_loc3_ != null && Boolean(_loc3_.isDubious))
         {
            _loc2_ = 16711680;
         }
