package tibia.creatures.statusWidgetClasses
{
   ...
   public class BitmapProgressBar extends UIComponent
   {
      ...
      private static function s_InitializeStyle() : void
      {
         ...
         {
            BitmapProgressBar.barImages = null;
            BitmapProgressBar.barLimits = null;
            BitmapProgressBar.fontColor = 16777215;
            BitmapProgressBar.fontFamily = "Verdana";
            BitmapProgressBar.fontSize = 11;
            BitmapProgressBar.fontStyle = "normal";
            BitmapProgressBar.fontWeight = "bold";
            BitmapProgressBar.paddingBottom = 0;
            BitmapProgressBar.paddingLeft = 0;
            BitmapProgressBar.paddingRight = 0;
            BitmapProgressBar.paddingTop = 0;
            BitmapProgressBar.leftOrnamentOffset = 0;
            BitmapProgressBar.rightOrnamentOffset = 0;
            BitmapProgressBar.tickOffset = 0;
         };
      ...
      private function cacheBarImages(param1:Boolean = false) : void
      {
         ...
         if(Boolean(param1) || this.m_StyleImageNames != _loc2_ || this.m_StyleImageLimits != _loc3_)
         {
