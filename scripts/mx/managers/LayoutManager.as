package mx.managers
{
   ...
   public class LayoutManager extends EventDispatcher implements ILayoutManager
   {
      ...
      public function validateNow() : void
      {
         ...
         {
            _loc1_ = 0;
            while(Boolean(callLaterPending) && _loc1_++ < 100)
            {
      ...
      private function doPhasedInstantiation() : void
      {
         ...
         if(Boolean(invalidatePropertiesFlag) || Boolean(invalidateSizeFlag) || Boolean(invalidateDisplayListFlag))
         {
            callLaterObject.callLater(doPhasedInstantiation);
         }
         else
      ...
      {
         return Boolean(invalidatePropertiesFlag) || Boolean(invalidateSizeFlag) || Boolean(invalidateDisplayListFlag);
      }
