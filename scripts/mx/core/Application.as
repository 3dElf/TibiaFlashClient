package mx.core
{
   ...
   public class Application extends LayoutContainer
   {
      ...
      {
         if(!super.id && this == Application.application && Boolean(ExternalInterface.available))
         {
      ...
      override protected function commitProperties() : void
      {
         ...
         if(Boolean(resizeWidth) || Boolean(resizeHeight))
         {
      ...
      public function addToCreationQueue(param1:Object, param2:int = -1, param3:Function = null, param4:IFlexDisplayObject = null) : void
      {
         ...
         if(Boolean(initialized) && !processingCreationQueue)
         {
            doNextQueueItem();
         }
      }
      ...
      override mx_internal function initThemeColor() : Boolean
      {
         ...
         if(!_loc1_)
         {
            ...
            if(Boolean(_loc2_) && Boolean(isNaN(_loc3_)) && Boolean(isNaN(_loc4_)))
            {
