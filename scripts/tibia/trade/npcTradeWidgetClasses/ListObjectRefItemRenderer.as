package tibia.trade.npcTradeWidgetClasses
{
   ...
   public class ListObjectRefItemRenderer extends UIComponent implements IListItemRenderer
   {
      ...
      private static function s_InitializeStyle() : void
      {
         ...
         {
            ListObjectRefItemRenderer.rendererHorizontalGap = 2;
            ListObjectRefItemRenderer.rendererVerticalGap = 0;
            ListObjectRefItemRenderer.rendererPaddingBottom = 2;
            ListObjectRefItemRenderer.rendererPaddingLeft = 2;
            ListObjectRefItemRenderer.rendererPaddingRight = 2;
            ListObjectRefItemRenderer.rendererPaddingTop = 2;
         };
      ...
      override protected function measure() : void
      {
         ...
         var _loc2_:Number = getStyle("rendererPaddingTop") + getStyle("rendererPaddingBottom");
         var _loc3_:Number = Math.max(this.m_UIObject.getExplicitOrMeasuredWidth(),this.m_UIName.getExplicitOrMeasuredHeight() + this.m_UIProperties.getExplicitOrMeasuredHeight());
