package tibia.creatures.selectOutfitWidgetClasses
{
   ...
   public class OutfitTypeSelector extends VBox
   {
      ...
      private static function s_InitializeStyle() : void
      {
         ...
         {
            OutfitTypeSelector.verticalGap = 2;
            OutfitTypeSelector.horizontalGap = 2;
            OutfitTypeSelector.paddingLeft = 2;
            OutfitTypeSelector.paddingRight = 2;
            OutfitTypeSelector.paddingTop = 2;
            OutfitTypeSelector.paddingBottom = 2;
         };
      ...
      private function set _3575610type(param1:int) : void
      {
         ...
         if(this.m_Type != param1 || Boolean(_loc2_))
         {
            this.m_Type = param1;
