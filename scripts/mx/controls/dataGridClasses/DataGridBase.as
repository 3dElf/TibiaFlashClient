package mx.controls.dataGridClasses
{
   ...
   public class DataGridBase extends ListBase implements IFontContextComponent
   {
      ...
      override protected function finishKeySelection() : void
      {
         ...
         if(Boolean(bSelectItem) && (caretIndex - verticalScrollPosition >= 0 || caretIndex < lockedRowCount))
         {
      ...
      override mx_internal function addClipMask(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            if(Boolean(horizontalScrollBar && horizontalScrollBar.visible || hasOnlyTextRenderers() || listContent.bottomOffset != 0 || listContent.topOffset != 0) || Boolean(listContent.leftOffset != 0) || listContent.rightOffset != 0)
            {
      ...
      {
         return Boolean(showHeaders) && headerHeight > 0;
      }
      ...
      override protected function adjustAfterRemove(param1:Array, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(Boolean(lockedRowCount) && Boolean(listItems.length) && Boolean(listItems[0].length))
         {
      ...
      override mx_internal function mouseEventToItemRendererOrEditor(param1:MouseEvent) : IListItemRenderer
      {
         ...
         if(Boolean(_loc2_) || _loc3_ == _loc4_)
         {
      ...
      protected function drawVisibleItem(param1:String, param2:Boolean = false, param3:Boolean = false, param4:Boolean = false, param5:Boolean = false) : void
      {
         ...
         if(Boolean(lockedRowCount) && Boolean(lockedRowContent) && Boolean(lockedRowContent.visibleData[param1]))
         {
      ...
      protected function makeRows(param1:ListBaseContentHolder, param2:Number, param3:Number, param4:Number, param5:Number, param6:int, param7:int, param8:Boolean = false, param9:uint = 0, param10:Boolean = false) : Point
      {
         ...
         while(!byCount && yy < bottom || Boolean(byCount) && rowsNeeded > 0)
         {
            ...
            if(Boolean(valid) && Boolean(variableRowHeight))
            {
         ...
         if(!byCount || Boolean(alwaysCleanup))
         {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(Boolean(lockedRowCountChanged) && Boolean(iterator))
         {
         ...
         if(Boolean(headerVisible) && Boolean(lockedColumnHeader))
         {
