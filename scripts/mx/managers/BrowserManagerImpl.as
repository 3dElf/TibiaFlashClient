package mx.managers
{
   ...
   public class BrowserManagerImpl extends EventDispatcher implements mx.managers.IBrowserManager
   {
      ...
      private function setup(param1:String, param2:String) : void
      {
         ...
         _isFirefoxMac = Boolean(_browserUserAgent && _browserPlatform) && _browserUserAgent.indexOf("Firefox") > -1 && _browserPlatform.indexOf("Mac") > -1;
      ...
      private function browserURLChange(param1:String, param2:Boolean = false) : void
      {
         ...
         if(param1 != null && decodeURI(_fragment) != decodeURI(param1) || Boolean(param2))
         {
            _fragment = param1;
            _loc3_ = url;
            _url = _base + "#" + param1;
