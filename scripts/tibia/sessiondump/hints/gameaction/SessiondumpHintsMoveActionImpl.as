package tibia.sessiondump.hints.gameaction
{
   ...
   public class SessiondumpHintsMoveActionImpl extends MoveActionImpl
   {
      ...
      {
         return Boolean(m_SourceAbsolute.equals(param1.sourcePosition)) && m_ObjectType.ID == param1.objectTypeID && m_MoveAmount == param1.objectAmount && Boolean(m_DestAbsolute.equals(param1.destinationPosition));
      }
   }
}
