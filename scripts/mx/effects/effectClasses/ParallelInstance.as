   ...
   public class ParallelInstance extends CompositeEffectInstance
   {
      ...
      override public function addChildSet(param1:Array) : void
      {
         ...
         if(param1.length > 0)
         {
            ...
            if(param1[0] is RotateInstance || _loc2_ != null && Boolean(_loc2_.hasRotateInstance()))
            {
               childSets.pop();
      ...
      override protected function onEffectEnd(param1:IEffectInstance) : void
      {
         ...
         if(Boolean(endEffectCalled) || activeEffectQueue == null)
         {
            return;
         }
      ...
      override public function play() : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            while(_loc6_ < _loc5_ && activeEffectQueue != null)
            {
               ...
               if(Boolean(playReversed) && _loc7_.actualDuration < durationWithoutRepeat)
               {
