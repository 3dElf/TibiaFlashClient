         ...
         while(true)
         {
            ...
            if(this.m_PacketLength == 0)
            {
               if(this.bytesAvailable(PACKET_MAGIC_BYTE_SIZE + PACKETLENGTH_SIZE + PACKET_TYPE_SIZE + PACKET_TIMESTAMP_SIZE))
               {
                  ...
                  if(Boolean(this.m_SkipClientPackets) && this.m_PacketType == PACKET_TYPE_CLIENT_MESSAGE)
                  {
            ...
            if(Boolean(this.m_HeaderComplete) && Boolean(this.bytesAvailable(this.m_PacketLength - 5)))
            {
