package mx.controls
{
    ...
    public class Menu extends List implements IFocusManagerContainer
    {
        ...
        function openSubMenu(param1:IListItemRenderer) : void
        {
            ...
            var _loc_10:* = _loc_9.localToGlobal(new Point(_loc_7, _loc_6));
            var _loc_11:* = _loc_10.x + _loc_3.getExplicitOrMeasuredWidth() - _loc_8.right;
            if (_loc_10.x + _loc_3.getExplicitOrMeasuredWidth() - _loc_8.right > 0 || _loc_10.x < _loc_8.x)
            {
            ...
            _loc_11 = _loc_10.y + _loc_3.getExplicitOrMeasuredHeight() - _loc_8.bottom;
        ...
        override protected function makeListData(param1:Object, param2:String, param3:int) : BaseListData
        {
            ...
            _loc_4.maxMeasuredIconWidth = maxMeasuredIconWidth;
        ...
        public function clearHighlight(param1:IListItemRenderer) : void
        {
            var _loc_4:* = null;
        ...
        public function show(param1:Object = null, param2:Object = null) : void
        {
            ...
            var _loc_5:* = _loc_4.getSandboxRoot();
            if (getRootMenu() != this)
            {
