package tibia.input.staticaction
{
    ...
    public class StaticActionList extends Object
    {
        ...
        private static function initialiseActionButtonTrigger() : void
        {
            ...
            while (_loc_1 < ActionBar.NUM_ACTIONS)
            {
                ...
                new TriggerSlot(768 + _loc_1, "MISC_TRIGGER_SLOT", InputEvent.KEY_DOWN | InputEvent.KEY_REPEAT, ActionBarSet.LOCATION_TOP, _loc_1);
                _loc_1++;
            }
            _loc_1 = 0;
            while (_loc_1 < ActionBar.NUM_ACTIONS)
            {
                ...
                new TriggerSlot(1280 + _loc_1, "MISC_TRIGGER_SLOT", InputEvent.KEY_DOWN | InputEvent.KEY_REPEAT, ActionBarSet.LOCATION_LEFT, _loc_1);
                _loc_1++;
            }
            _loc_1 = 0;
            while (_loc_1 < ActionBar.NUM_ACTIONS)
            {
                ...
                new TriggerSlot(1536 + _loc_1, "MISC_TRIGGER_SLOT", InputEvent.KEY_DOWN | InputEvent.KEY_REPEAT, ActionBarSet.LOCATION_RIGHT, _loc_1);
                _loc_1++;
            }
            _loc_1 = 0;
            while (_loc_1 < ActionBar.NUM_ACTIONS)
            {
                ...
                new TriggerSlot(1024 + _loc_1, "MISC_TRIGGER_SLOT", InputEvent.KEY_DOWN | InputEvent.KEY_REPEAT, ActionBarSet.LOCATION_BOTTOM, _loc_1);
                _loc_1++;
            }
            return;
        }// end function
