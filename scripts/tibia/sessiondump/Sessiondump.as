   ...
   public class Sessiondump extends EventDispatcher implements IServerConnection
   {
      ...
      public function readCommunicationData() : void
      {
         ...
         while(this.m_SessiondumpReader.packetReader.containsUnreadMessage)
         {
            ...
            if(this.m_KeyframeState == KEYFRAME_STATE_SKIP && Type != SKEYFRAMEEND && Type != SCREATUREDATA || Boolean(this.m_SessiondumpReader.packetReader.isClientPacket))
            {
            ...
            else
            {
               try
               {
                  ...
                  if(Boolean(this.messageReader.messageWasRead) && Boolean(hasEventListener(SessiondumpEvent.MESSAGE_PROCESSED)))
                  {
                  ...
                  if(Boolean(this.isConnected) && this.messageReader.messageWasRead == false)
                  {
      ...
      {
         if(this.m_State == STATE_DEFAULT || Boolean(this.sessiondumpDone))
         {
