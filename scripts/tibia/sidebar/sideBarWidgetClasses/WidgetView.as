package tibia.sidebar.sideBarWidgetClasses
{
   ...
   public class WidgetView extends Box
   {
      ...
      private static function s_InitializeStyle() : void
      {
         ...
         {
            WidgetView.iconLeft = 0;
            WidgetView.iconTop = 0;
            WidgetView.iconWidth = 0;
            WidgetView.iconHeight = 0;
            WidgetView.iconImage = undefined;
            WidgetView.headerLeft = 0;
            WidgetView.headerTop = 0;
            WidgetView.headerWidth = 0;
            WidgetView.headerHeight = 0;
            WidgetView.titleFontFamily = undefined;
            WidgetView.titleFontWeight = undefined;
            WidgetView.titleFontSize = undefined;
            WidgetView.titleFontColor = undefined;
            WidgetView.footerTop = 0;
            WidgetView.footerLeft = 0;
            WidgetView.footerWidth = 0;
            WidgetView.footerHeight = 0;
         };
      ...
      function get widgetRequiredHeight() : Number
      {
         ...
         if(Boolean(this.m_WidgetResizable) && !isNaN(explicitMinHeight))
         {
            return explicitMinHeight;
         }
         if(Boolean(this.m_WidgetResizable) && !isNaN(measuredMinHeight))
         {
      ...
      {
         if(this.widgetInstance != null && Boolean(this.widgetInstance.collapsible))
         {
      ...
      function resizeWidgetAbsolute(param1:Number, param2:Boolean) : Number
      {
         ...
         if(Boolean(this.m_WidgetClosed) || Boolean(this.m_WidgetCollapsed) || !this.m_WidgetResizable)
         {
            return 0;
         }
         _loc3_ = NaN;
