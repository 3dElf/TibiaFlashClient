package tibia.market.marketWidgetClasses
{
    ...
    class AppearanceTypeCategoryFilterEditor extends VBox implements IAppearanceTypeFilterEditor
    {
        ...
        function AppearanceTypeCategoryFilterEditor()
        {
            ...
            if (_loc_1 != null)
            {
                this.filterCategory = _loc_1.marketBrowserCategory;
                this.filterLevel = _loc_1.marketBrowserLevel;
                this.filterProfession = _loc_1.marketBrowserProfession;
                this.filterBodyPosition = _loc_1.marketBrowserBodyPosition;
            }
            var _loc_2:* = Tibia.s_GetPlayer();
            if (_loc_2 != null)
            {
                _loc_2.addEventListener(PropertyChangeEvent.PROPERTY_CHANGE, this.onPlayerChange, false, EventPriority.DEFAULT, true);
            }
            return;
        }// end function
        ...
        private function onCategoryCange(event:Event) : void
        {
            var _loc_2:* = null;
        ...
        override protected function commitProperties() : void
        {
            ...
            if (this.m_UncommittedCategory)
            {
                if (_loc_1 != null)
                {
                    _loc_1.marketBrowserCategory = this.filterCategory;
                }
            ...
            if (this.m_UncommittedLevel)
            {
                if (_loc_1 != null)
                {
                    _loc_1.marketBrowserLevel = this.filterLevel;
                }
            ...
            if (this.m_UncommittedProfession)
            {
                if (_loc_1 != null)
                {
                    _loc_1.marketBrowserProfession = this.filterProfession;
                }
            ...
            if (this.m_UncommittedBodyPosition)
            {
                if (_loc_1 != null)
                {
                    _loc_1.marketBrowserBodyPosition = this.filterBodyPosition;
                }
        ...
        private function onBodyPositionChange(event:Event) : void
        {
            var _loc_2:* = null;
            var _loc_3:* = event.currentTarget as ComboBox;
            _loc_2 = event.currentTarget as ComboBox;
            if (event != null && _loc_3 != null && _loc_2.enabled)
            {
                this.filterBodyPosition = _loc_2.selectedItem.value;
            }
            return;
        }// end function
        ...
        private function getValueIndex(param1:ComboBox, param2:int) : int
        {
            ...
            if (param1 != null)
            {
                _loc_3 = param1.dataProvider as ArrayCollection;
                if (_loc_3 != null)
                {
                    return ArrayHelper.s_IndexOf(_loc_3.source, "value", param2);
                }
            }
            return -1;
        }// end function
        ...
        override protected function createChildren() : void
        {
            ...
            if (!this.m_UIConstructed)
            {
                ...
                this.m_UIPrimaryCategory.dataProvider = [{value:MarketWidget.CATEGORY_AMULETS, label:resourceManager.getString(BUNDLE, "CATEGORY_AMULETS_LABEL")}, {value:MarketWidget.CATEGORY_ARMORS, label:resourceManager.getString(BUNDLE, "CATEGORY_ARMORS_LABEL")}, {value:MarketWidget.CATEGORY_BOOTS, label:resourceManager.getString(BUNDLE, "CATEGORY_BOOTS_LABEL")}, {value:MarketWidget.CATEGORY_CONTAINERS, label:resourceManager.getString(BUNDLE, "CATEGORY_CONTAINERS_LABEL")}, {value:MarketWidget.CATEGORY_DECORATION, label:resourceManager.getString(BUNDLE, "CATEGORY_DECORATION_LABEL")}, {value:MarketWidget.CATEGORY_FOOD, label:resourceManager.getString(BUNDLE, "CATEGORY_FOOD_LABEL")}, {value:MarketWidget.CATEGORY_HELMETS_HATS, label:resourceManager.getString(BUNDLE, "CATEGORY_HELMETS_HATS_LABEL")}, {value:MarketWidget.CATEGORY_LEGS, label:resourceManager.getString(BUNDLE, "CATEGORY_LEGS_LABEL")}, {value:MarketWidget.CATEGORY_OTHERS, label:resourceManager.getString(BUNDLE, "CATEGORY_OTHERS_LABEL")}, {value:MarketWidget.CATEGORY_POTIONS, label:resourceManager.getString(BUNDLE, "CATEGORY_POTIONS_LABEL")}, {value:MarketWidget.CATEGORY_RINGS, label:resourceManager.getString(BUNDLE, "CATEGORY_RINGS_LABEL")}, {value:MarketWidget.CATEGORY_RUNES, label:resourceManager.getString(BUNDLE, "CATEGORY_RUNES_LABEL")}, {value:MarketWidget.CATEGORY_SHIELDS, label:resourceManager.getString(BUNDLE, "CATEGORY_SHIELDS_LABEL")}, {value:MarketWidget.CATEGORY_TIBIA_COINS, label:resourceManager.getString(BUNDLE, "CATEGORY_TIBIA_COINS")}, {value:MarketWidget.CATEGORY_TOOLS, label:resourceManager.getString(BUNDLE, "CATEGORY_TOOLS_LABEL")}, {value:MarketWidget.CATEGORY_VALUABLES, label:resourceManager.getString(BUNDLE, "CATEGORY_VALUABLES_LABEL")}, {value:MarketWidget.CATEGORY_META_WEAPONS, label:resourceManager.getString(BUNDLE, "CATEGORY_META_WEAPONS_LABEL")}];
                ...
                this.m_UIWeaponCategory.dataProvider = [{value:MarketWidget.CATEGORY_AMMUNITION, label:resourceManager.getString(BUNDLE, "CATEGORY_AMMUNITION_LABEL")}, {value:MarketWidget.CATEGORY_AXES, label:resourceManager.getString(BUNDLE, "CATEGORY_AXES_LABEL")}, {value:MarketWidget.CATEGORY_CLUBS, label:resourceManager.getString(BUNDLE, "CATEGORY_CLUBS_LABEL")}, {value:MarketWidget.CATEGORY_DISTANCE_WEAPONS, label:resourceManager.getString(BUNDLE, "CATEGORY_DISTANCE_WEAPONS_LABEL")}, {value:MarketWidget.CATEGORY_SWORDS, label:resourceManager.getString(BUNDLE, "CATEGORY_SWORDS_LABEL")}, {value:MarketWidget.CATEGORY_WANDS_RODS, label:resourceManager.getString(BUNDLE, "CATEGORY_WANDS_RODS_LABEL")}];
                ...
                this.m_UILevel.addEventListener(Event.CHANGE, function (event:Event) : void
            {
                ...
                this.m_UIProfession.addEventListener(Event.CHANGE, function (event:Event) : void
            {
        ...
        public function adjustFilterFunction(param1:AppearanceType) : void
        {
            ...
            if (_loc_2 != null)
            {
                this.filterLevel = this.filterLevel && _loc_2.level >= param1.marketRestrictLevel;
                this.filterProfession = this.filterProfession && (1 << _loc_2.profession & param1.marketRestrictProfession) != 0;
            }
            else
            {
        ...
        public function get filterFunction() : Function
        {
            ...
            if (this.m_FilterFunction == null)
            {
                ...
                this.m_FilterFunction = closure({category:this.filterCategory, level:Level, profession:Profession, bodyPosition:this.filterBodyPosition}, function (param1:AppearanceType) : Boolean
            {
