package tibia.actionbar.widgetClasses
{
   ...
   public class ActionBarWidget extends Container
   {
      ...
      private function onButtonActionDragEvent(param1:DragEvent) : void
      {
         ...
         var _loc5_:int = -1;
         if((this.options == null || !this.options.generalActionBarsLock) && (_loc2_ = param1.currentTarget as IActionButton) != null && (_loc3_ = param1.dragSource) != null && Boolean(_loc3_.hasFormat("dragType")) && _loc3_.dataForFormat("dragType") == DRAG_TYPE_ACTION && Boolean(_loc3_.hasFormat("dragActionBar")) && (_loc4_ = _loc3_.dataForFormat("dragActionBar") as ActionBar) != null && Boolean(_loc3_.hasFormat("dragActionPosition")) && 0 <= (_loc5_ = int(_loc3_.dataForFormat("dragActionPosition"))) && _loc5_ <= ActionBar.NUM_ACTIONS && this.m_ActionBar != null)
         {
            if(param1.type == DragEvent.DRAG_DROP)
            {
               ...
               _loc7_ = null;
               _loc8_ = null;
               if(Boolean(param1.shiftKey) && this.options != null && (_loc7_ = this.options.getMappingSet(this.options.generalInputSetID)) != null && (_loc8_ = this.options.generalInputSetMode == MappingSet.CHAT_MODE_OFF?_loc7_.chatModeOff:_loc7_.chatModeOn) != null)
               {
      ...
      private function onCreationComplete(param1:FlexEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.addEventListener(ConnectionEvent.CONNECTED,this.onConnectionEstablished,false,EventPriority.DEFAULT,true);
         }
      }
      ...
      private function onButtonObjectDragEvent(param1:DragEvent) : void
      {
         ...
         if((this.options == null || !this.options.generalActionBarsLock) && (_loc2_ = param1.currentTarget as IActionButton) != null && (_loc3_ = param1.dragSource) != null && Boolean(_loc3_.hasFormat("dragType")) && _loc3_.dataForFormat("dragType") == DRAG_TYPE_OBJECT && Boolean(_loc3_.hasFormat("dragObject")) && (_loc4_ = _loc3_.dataForFormat("dragObject") as ObjectInstance) != null && (_loc5_ = _loc4_.type) != null && Boolean(_loc5_.isTakeable) && this.m_ActionBar != null)
         {
            if(param1.type == DragEvent.DRAG_DROP)
            {
               _loc6_ = null;
               _loc7_ = Boolean(_loc5_.isLiquidContainer) || Boolean(_loc5_.isLiquidPool)?int(_loc4_.data):0;
               if(_loc5_.isCloth)
               {
      ...
      private function updateToolTips() : void
      {
         ...
         while(_loc4_ < _loc7_)
         {
            while(_loc5_ < _loc7_ && Boolean(_loc3_[_loc4_].equals(_loc3_[_loc5_])))
            {
               _loc5_++;
            }
            if(_loc5_ - _loc4_ > 1)
      ...
      override protected function measure() : void
      {
         ...
         var _loc6_:Number = this.m_UIScrollUpButton.getExplicitOrMeasuredWidth() + this.m_UIScrollDownButton.getExplicitOrMeasuredWidth();
      ...
      private function onButtonSpellDragEvent(param1:DragEvent) : void
      {
         ...
         if((this.options == null || !this.options.generalActionBarsLock) && (_loc2_ = param1.currentTarget as IActionButton) != null && (_loc3_ = param1.dragSource) != null && Boolean(_loc3_.hasFormat("dragType")) && _loc3_.dataForFormat("dragType") == DRAG_TYPE_SPELL && Boolean(_loc3_.hasFormat("dragSpell")) && (_loc4_ = _loc3_.dataForFormat("dragSpell") as Spell) != null && this.m_ActionBar != null)
         {
            if(param1.type == DragEvent.DRAG_DROP)
            {
