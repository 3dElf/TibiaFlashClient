package tibia.creatures
{
   ...
   public class Player extends Creature
   {
      ...
      override function animateMovement(param1:Number) : void
      {
         ...
         if(!m_MovementRunning && Boolean(this.m_AutowalkPathDelta.isZero()))
         {
      ...
      public function getSpellCasts(param1:Spell) : int
      {
         var _loc2_:int = 0;
         var _loc3_:int = 0;
         if(param1 == null || !this.isSpellKnown(param1) || param1.restrictLevel > getSkillValue(SKILL_LEVEL) || Boolean(param1.restrictPremium) && !this.premium || (param1.restrictProfession & 1 << this.profession) == 0)
         {
            return -1;
         }
