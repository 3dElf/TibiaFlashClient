   ...
   public class _Tibia_mx_managers_SystemManager extends SystemManager implements IFlexModuleFactory
   {
      ...
      override public function info() : Object
      {
         return {
            ...
            "compiledResourceBundleNames":["ActionBarWidget","ActionButtonConfigurationWidget","BattlelistWidget","BodyContainerViewWidget","BuddylistWidget","BugReportWidget","ChannelSelectionWidget","CharacterProfileWidget","CharacterSelectionWidget","ChatStorage","ChatWidget","CombatControlWidget","Communication","Connection","ContainerViewWidget","EditBuddyWidget","EditListWidget","EditMarkWidget","EditTextWidget","GeneralButtonsWidget","Global","InputHandler","MarketWidget","MessageMode","MiniMapWidget","NPCTradeWidget","ObjectContextMenu","OptionsConfigurationWidget","QuestLogWidget","ReportWidget","SafeTradeWidget","SelectOutfitWidget","SharedResources","SideBarHeader","SpellListWidget","SplitStackWidget","StaticAction","StatusWidget","Tibia","TutorialHintWidget","WorldMapStorage","collections","containers","controls","core","effects","formatters","skins","styles","utils"],
            "currentDomain":ApplicationDomain.currentDomain,
            "deactivate":"onActivation(event)",
            "layout":"absolute",
            "mainClassName":"Tibia",
            "mixins":["_Tibia_FlexInit","_DividedBoxStyle","_alertButtonStyleStyle","_FormHeadingStyle","_SWFLoaderStyle","_FormStyle","_headerDateTextStyle","_todayStyleStyle","_windowStylesStyle","_FormItemLabelStyle","_TextInputStyle","_dateFieldPopupStyle","_ApplicationControlBarStyle","_FormItemStyle","_ComboBoxStyle","_dataGridStylesStyle","_TabStyle","_headerDragProxyStyleStyle","_popUpMenuStyle","_TabNavigatorStyle","_HSliderStyle","_DragManagerStyle","_windowStatusStyle","_TextAreaStyle","_ContainerStyle","_swatchPanelTextFieldStyle","_RadioButtonStyle","_ButtonBarStyle","_textAreaHScrollBarStyleStyle","_MenuBarStyle","_comboDropdownStyle","_CheckBoxStyle","_ButtonStyle","_linkButtonStyleStyle","_richTextEditorTextAreaStyleStyle","_ControlBarStyle","_textAreaVScrollBarStyleStyle","_globalStyle","_ListBaseStyle","_TabBarStyle","_ApplicationStyle","_TileListStyle","_ToolTipStyle","_CursorManagerStyle","_ButtonBarButtonStyle","_opaquePanelStyle","_errorTipStyle","_MenuStyle","_TreeStyle","_DataGridStyle","_HRuleStyle","_activeTabStyleStyle","_ScrollBarStyle","_plainStyle","_activeButtonStyleStyle","_DataGridItemRendererStyle","_weekDayStyleStyle","_TibiaWatcherSetupUtil"],
