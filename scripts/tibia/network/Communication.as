package tibia.network
{
    ...
    public class Communication extends Object implements IServerCommunication
    {
        ...
        public static const CLIENT_VERSION:uint = 2494;
        ...
        protected function readSSHOWMESSAGEDIALOG(param1:ByteArray) : void
        {
            ...
            if (_loc_2 == MESSAGEDIALOG_IMBUEMENT_SUCCESS || _loc_2 == MESSAGEDIALOG_IMBUEMENT_ERROR || _loc_2 == MESSAGEDIALOG_IMBUEMENT_ROLL_FAILED || _loc_2 == MESSAGEDIALOG_IMBUING_STATION_NOT_FOUND || _loc_2 == MESSAGEDIALOG_CLEARING_CHARM_SUCCESS || _loc_2 == MESSAGEDIALOG_CLEARING_CHARM_ERROR)
            {
                ImbuingManager.getInstance().showImbuingResultDialog(_loc_3);
            }
            else if (_loc_2 == MESSAGEDIALOG_PREY_MESSAGE || _loc_2 == MESSAGEDIALOG_PREY_ERROR)
            {
                _loc_4 = PreyWidget.s_GetCurrentInstance();
                if (_loc_4 != null)
                {
                    _loc_4.showMessageDialog(_loc_3);
                }
            }
            return;
        }// end function
        ...
        protected function readSPREYDATA(param1:ByteArray) : void
        {
            ...
            else if (_loc_4 == PreyData.STATE_ACTIVE)
            {
                ...
                _loc_8 = param1.readUnsignedShort();
                _loc_9 = param1.readUnsignedByte();
                _loc_2.changeStateToActive(_loc_3, _loc_7, _loc_8, _loc_9, new PreyMonsterInformation(_loc_5, _loc_6));
                _loc_2.setPreyTimeLeft(_loc_3, param1.readUnsignedShort());
            }
            else if (_loc_4 == PreyData.STATE_SELECTION)
            {
                _loc_10 = param1.readUnsignedByte();
                _loc_11 = new Vector.<PreyMonsterInformation>;
                _loc_12 = 0;
                while (_loc_12 < _loc_10)
                {
                    ...
                    _loc_5 = StringHelper.s_ReadLongStringFromByteArray(param1);
                    _loc_6 = this.readCreatureOutfit(param1, null);
                    _loc_11.push(new PreyMonsterInformation(_loc_5, _loc_6));
                    _loc_12 = _loc_12 + 1;
                }
                _loc_2.changeStateToSelection(_loc_3, _loc_11);
            }
            else if (_loc_4 == PreyData.STATE_SELECTION_CHANGE_MONSTER)
            {
                ...
                _loc_2.changeStateToSelectionChangeMonster(_loc_3, _loc_7, _loc_8, _loc_9, _loc_11);
            }
