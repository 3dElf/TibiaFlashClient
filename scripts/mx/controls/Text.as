package mx.controls
{
   ...
   public class Text extends Label
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(isSpecialCase())
         {
            _loc7_ = Boolean(isNaN(lastUnscaledWidth)) || lastUnscaledWidth != param1;
      ...
      private function isSpecialCase() : Boolean
      {
         ...
         return (!isNaN(percentWidth) || !isNaN(_loc1_) && !isNaN(_loc2_)) && Boolean(isNaN(explicitHeight)) && Boolean(isNaN(percentHeight));
      }
   }
}
