package tibia.worldmap
{
   ...
   public class WorldMapStorage
   {
      ...
      public function addOnscreenMessage(... rest) : void
      {
         ...
         if(this.m_Options != null && (_loc10_ = this.m_Options.getMessageFilterSet(MessageFilterSet.DEFAULT_SET)) != null && (_loc11_ = _loc10_.getMessageMode(_loc6_)) != null && Boolean(_loc11_.showOnscreenMessage) && (_loc13_ = _loc11_.onscreenTarget) != ONSCREEN_TARGET_NONE && (_loc12_ = this.m_Options.getNameFilterSet(NameFilterSet.DEFAULT_SET)) != null && (Boolean(_loc11_.ignoreNameFilter) || Boolean(_loc12_.acceptMessage(_loc6_,_loc4_,_loc7_))))
         {
            if(_loc13_ == ONSCREEN_TARGET_BOX_COORDINATE || _loc13_ == ONSCREEN_TARGET_BOX_TOP || _loc13_ == ONSCREEN_TARGET_BOX_HIGH || _loc13_ == ONSCREEN_TARGET_BOX_LOW || _loc13_ == ONSCREEN_TARGET_BOX_BOTTOM)
            {
               ...
               if(_loc13_ == ONSCREEN_TARGET_BOX_COORDINATE)
               {
                  ...
                  {
                     if(this.m_MessageBoxes[_loc17_].position == null || Boolean(this.m_MessageBoxes[_loc17_].position.equals(_loc2_)))
                     {
      ...
      public function changeObject(param1:int, param2:int, param3:int, param4:int, param5:ObjectInstance) : ObjectInstance
      {
         ...
         if(_loc6_ != null && Boolean(_loc6_.type.isFullBank) || Boolean(param5.type.isFullBank))
         {
            this.m_CacheFullbank = false;
         }
         return _loc6_;
      ...
      public function expireOldestMessage() : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            if(Boolean(this.m_MessageBoxes[_loc2_].empty) && _loc2_ >= ONSCREEN_TARGET_BOX_COORDINATE)
            {
      ...
      public function putObject(param1:int, param2:int, param3:int, param4:ObjectInstance) : ObjectInstance
      {
         ...
         if(_loc5_ != null && Boolean(_loc5_.type.isFullBank) || Boolean(param4.type.isFullBank))
         {
            this.m_CacheFullbank = false;
         }
         return _loc5_;
      ...
      public function deleteObject(param1:int, param2:int, param3:int, param4:int) : ObjectInstance
      {
         ...
         if(_loc5_ != null && Boolean(_loc5_.type.isFullBank))
         {
            this.m_CacheFullbank = false;
         }
         return _loc5_;
      ...
      public function appendEffect(param1:int, param2:int, param3:int, param4:AppearanceInstance) : void
      {
         ...
         if(_loc7_ != null && param4 is TextualEffectInstance)
         {
            ...
            while(_loc8_ >= 0)
            {
               ...
               if(_loc9_ is TextualEffectInstance && Boolean(TextualEffectInstance(_loc9_).merge(param4)))
               {
                  return;
               }
               _loc8_--;
      ...
      public function isVisible(param1:int, param2:int, param3:int, param4:Boolean) : Boolean
      {
         ...
         return _loc5_ != null && (Boolean(param4) || this.m_Position.z == param3);
      }
      ...
      public function animate() : void
      {
         ...
         while(_loc2_ >= 0)
         {
            ...
            if(Boolean(this.m_MessageBoxes[_loc2_].empty) && _loc2_ >= ONSCREEN_TARGET_BOX_COORDINATE)
            {
               ...
               {
                  if(this.m_MessageBoxes[_loc3_].position == null || Boolean(this.m_MessageBoxes[_loc3_].position.equals(this.m_MessageBoxes[_loc2_].position)))
                  {
