   ...
   public class ModifiedCollectionView implements mx.collections.ICollectionView
   {
      ...
      mx_internal function getWrappedItemUsingCursor(param1:ModifiedCollectionViewCursor, param2:int) : Object
      {
         ...
         while(_loc8_ < deltas.length)
         {
            ...
            {
               if(_loc3_ == _loc6_.index && Boolean(_loc6_.showOldReplace) && Boolean(_showPreserved))
               {
                  _loc5_ = _loc6_;
                  break;
               }
               if(_loc3_ == _loc6_.index + 1 && Boolean(_loc6_.showOldReplace) && Boolean(_loc6_.showNewReplace) && Boolean(_showPreserved))
               {
                  _loc3_--;
                  _loc7_ = true;
                  break;
               }
               if(_loc3_ == _loc6_.index && (!_loc6_.showOldReplace && Boolean(_loc6_.showNewReplace) || !_showPreserved))
               {
                  _loc7_ = true;
                  break;
               }
            ...
            {
               if(_loc3_ == _loc6_.index && Boolean(_loc6_.isRemove))
               {
                  _loc5_ = _loc6_;
                  break;
               }
      ...
      private function integrateReplacedElements(param1:CollectionEvent, param2:int, param3:int) : void
      {
         ...
         while(_loc4_ < deltas.length && _loc5_ < _loc7_)
         {
            ...
            if(Boolean(_loc11_.isRemove) && _loc11_.index <= _loc12_.index || !_loc11_.isRemove && _loc11_.index < _loc12_.index)
            {
               _loc4_++;
            }
      ...
      {
         if(Boolean(param2) && (Boolean(param2.isRemove) || param2.modificationType == CollectionModification.REPLACE && !param4))
         {
      ...
      private function integrateRemovedElements(param1:CollectionEvent, param2:int, param3:int) : void
      {
         ...
         while(_loc4_ < deltas.length && _loc5_ < _loc7_)
         {
            ...
            if(Boolean(_loc9_.isRemove) && _loc9_.index <= _loc10_.index || !_loc9_.isRemove && _loc9_.index < _loc10_.index)
            {
               _loc4_++;
            }
            else
...
class ModifiedCollectionViewCursor extends EventDispatcher implements IViewCursor
{
   ...
   function ModifiedCollectionViewCursor(param1:ModifiedCollectionView, param2:IViewCursor, param3:Object)
   {
      ...
      if(Boolean(cursor.beforeFirst) && !current)
      {
         internalIndex = BEFORE_FIRST_INDEX;
      }
      else if(Boolean(cursor.afterLast) && !current)
      {
