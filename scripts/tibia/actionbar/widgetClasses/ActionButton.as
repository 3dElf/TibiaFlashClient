package tibia.actionbar.widgetClasses
{
   ...
   public class ActionButton extends UIComponent implements IActionButton
   {
      ...
      private static function initialiseStyle() : void
      {
         ...
         {
            ActionButton.backgroundImage = undefined;
            ActionButton.backgroundColor = 0;
            ActionButton.backgroundAlpha = 1;
            ActionButton.backgroundLabelColor = 16777215;
            ActionButton.overlayCooldownImage = undefined;
            ActionButton.overlayDisabledImage = undefined;
            ActionButton.overlayHighlightImage = undefined;
            ActionButton.paddingBottom = 2;
            ActionButton.paddingLeft = 2;
            ActionButton.paddingRight = 2;
            ActionButton.paddingTop = 2;
         };
      ...
      override protected function commitProperties() : void
      {
         ...
         if(Boolean(this.m_UncommittedActionBar) || Boolean(this.m_UncommittedPosition))
         {
            this.drawLabel();
