package tibia.worldmap
{
   ...
   public class WorldMapWidget extends UIComponent implements IUseWidget, IMoveWidget
   {
      ...
      private function onMouseMove(param1:MouseEvent) : void
      {
         ...
         if(Boolean(this.m_MouseCursorOverRenderer) && this.m_UIRendererImpl != null && this.m_Options != null && this.m_Options.rendererHighlight > 0 && ContextMenuBase.getCurrent() == null && PopUpBase.getCurrent() == null)
         {
      ...
      public function determineAction(param1:MouseEvent, param2:Boolean = false, param3:Boolean = false, param4:Boolean = false) : uint
      {
         ...
         if(this.m_WorldMapStorage != null && this.m_Player != null && (_loc5_ = Tibia.s_GetCommunication()) != null && Boolean(_loc5_.isGameRunning) && this.m_UIRendererImpl != null && (_loc8_ = this.m_UIRendererImpl.pointToMap(s_TempPoint.x,s_TempPoint.y,false)) != null)
         {
            ...
            if(_loc6_ != ACTION_SMARTCLICK && _loc6_ != ACTION_AUTOWALK || _loc8_.z == this.m_WorldMapStorage.m_PlayerZPlane)
            {
               ...
               else if(_loc14_.object != null && Boolean(AppearanceInstance(_loc14_.object).type.isUsable))
               {
         ...
         if(Boolean(param3) && this.m_Options != null && this.m_Options.mouseMapping != null && Boolean(this.m_Options.mouseMapping.showMouseCursorForAction))
         {
