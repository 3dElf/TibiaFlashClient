package mx.core
{
   ...
   public class Container extends UIComponent implements IContainer, IDataRenderer, IFocusManagerContainer, IListItemRenderer, IRawChildrenContainer
   {
      ...
      private function createContentPaneAndScrollbarsIfNeeded() : Boolean
      {
         ...
         if(Boolean(_loc2_) && Boolean(border))
         {
            updateBackgroundImageRect();
         }
         return _loc2_;
      ...
      protected function scrollChildren() : void
      {
         ...
         if(Boolean(border) && Boolean(border is IRectangularBorder) && Boolean(IRectangularBorder(border).hasBackgroundImage))
         {
      ...
      override public function notifyStyleChangeInChildren(param1:String, param2:Boolean) : void
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if(Boolean(contentPane) || Boolean(_loc4_ < _firstChildIndex) || _loc4_ >= _firstChildIndex + _numChildren)
            {
      ...
      protected function createBorder() : void
      {
         ...
         if(!border && Boolean(isBorderNeeded()))
         {
      ...
      public function get viewMetrics() : mx.core.EdgeMetrics
      {
         ...
         var _loc2_:Boolean = verticalScrollBar != null && (Boolean(doingLayout) || verticalScrollPolicy == ScrollPolicy.ON);
         var _loc3_:Boolean = horizontalScrollBar != null && (Boolean(doingLayout) || horizontalScrollPolicy == ScrollPolicy.ON);
         if(!_loc2_ && !_loc3_)
         {
            return _loc1_;
         }
      ...
      public function createComponentFromDescriptor(param1:ComponentDescriptor, param2:Boolean) : mx.core.IFlexDisplayObject
      {
         ...
         if((numChildrenBefore != 0 || numChildrenCreated != -1) && _loc3_.instanceIndices == null && Boolean(hasChildMatchingDescriptor(_loc3_)))
         {
            return null;
         }
      ...
      override public function set focusPane(param1:Sprite) : void
      {
         ...
         if(Boolean(param1) && Boolean(contentPane))
         {
      ...
      mx_internal function createContentPane() : void
      {
         ...
         if(border)
         {
            ...
            if(border is IRectangularBorder && Boolean(IRectangularBorder(border).hasBackgroundImage))
            {
               _loc3_++;
            }
         }
      ...
      override public function removeChild(param1:DisplayObject) : DisplayObject
      {
         ...
         if(param1 is UIComponent && Boolean(UIComponent(param1).isDocument))
         {
      ...
      override public function regenerateStyleCache(param1:Boolean) : void
      {
         ...
         if(contentPane)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               ...
               if(Boolean(param1) && _loc4_ is UIComponent)
               {
      ...
      override public function setChildIndex(param1:DisplayObject, param2:int) : void
      {
         ...
         if(contentPane)
         {
            ...
            if(Boolean(_autoLayout) || Boolean(forceLayout))
            {
               invalidateDisplayList();
            }
         }
      ...
      private function createScrollbarsIfNeeded(param1:Rectangle) : Boolean
      {
         ...
         var _loc10_:Boolean = Boolean(_loc8_) || Boolean(_loc9_) || Boolean(_loc6_) || overlay != null || _loc7_.left > 0 || _loc7_.top > 0;
         if(_loc4_ < _loc2_)
         {
            _loc10_ = true;
         ...
         if(Boolean(_loc8_ && _loc9_ && horizontalScrollPolicy == ScrollPolicy.AUTO && verticalScrollPolicy == ScrollPolicy.AUTO && horizontalScrollBar && verticalScrollBar) && Boolean(_loc4_ + verticalScrollBar.minWidth >= _loc2_) && _loc5_ + horizontalScrollBar.minHeight >= _loc3_)
         {
            _loc8_ = Boolean(_loc9_ = Boolean(false));
         }
         else if(Boolean(_loc8_ && !_loc9_ && verticalScrollBar) && Boolean(horizontalScrollPolicy == ScrollPolicy.AUTO) && _loc4_ + verticalScrollBar.minWidth >= _loc2_)
         {
            _loc8_ = false;
         }
         var _loc11_:Boolean = createOrDestroyScrollbars(_loc8_,_loc9_,_loc10_);
         if(scrollableWidth != _loc2_ || viewableWidth != _loc4_ || Boolean(_loc11_))
         {
            if(horizontalScrollBar)
            {
         ...
         if(scrollableHeight != _loc3_ || viewableHeight != _loc5_ || Boolean(_loc11_))
         {
            if(verticalScrollBar)
            {
      ...
      override public function styleChanged(param1:String) : void
      {
         ...
         if(Boolean(_loc2_) || Boolean(StyleManager.isSizeInvalidatingStyle(param1)))
         {
            invalidateDisplayList();
         }
         if(Boolean(_loc2_) || param1 == "borderSkin")
         {
            if(border)
            {
         ...
         if(Boolean(_loc2_) || param1 == "borderStyle" || param1 == "backgroundColor" || param1 == "backgroundImage" || param1 == "mouseShield" || param1 == "mouseShieldChildren")
         {
            createBorder();
         }
         ...
         if(Boolean(_loc2_) || param1 == "horizontalScrollBarStyleName")
         {
         ...
         if(Boolean(_loc2_) || param1 == "verticalScrollBarStyleName")
         {
      ...
      {
         var _loc2_:Rectangle = Boolean(contentPane) && Boolean(contentPane.scrollRect)?contentPane.scrollRect:null;
         if(_loc2_)
         {
            contentPane.scrollRect = null;
         }
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void
      {
         ...
         if(Boolean(contentPane) && Boolean(contentPane.scrollRect))
         {
            ...
            if(!_clipContent || Boolean(isNaN(Number(_loc3_))) || _loc3_ === "" || !(Boolean(horizontalScrollBar) || Boolean(verticalScrollBar)) && !cacheAsBitmap)
            {
               _loc3_ = null;
            }
