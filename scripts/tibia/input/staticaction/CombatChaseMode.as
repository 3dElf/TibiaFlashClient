package tibia.input.staticaction
{
    ...
    public class CombatChaseMode extends StaticAction
    {
        ...
        override public function perform(param1:Boolean = false) : void
        {
            ...
            if (_loc_2 != null)
            {
                if (_loc_2.combatChaseMode == OptionsStorage.COMBAT_CHASE_OFF)
                {
                    _loc_2.combatChaseMode = OptionsStorage.COMBAT_CHASE_ON;
                }
                else
                {
                    _loc_2.combatChaseMode = OptionsStorage.COMBAT_CHASE_OFF;
                }
            }
