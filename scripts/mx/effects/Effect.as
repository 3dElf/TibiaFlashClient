   ...
   public class Effect extends EventDispatcher implements IEffect
   {
      ...
      private static function stripUnchangedValues(param1:Array) : Array
      {
         ...
         while(_loc2_ < param1.length)
         {
            ...
            {
               if(param1[_loc2_].start[_loc3_] == param1[_loc2_].end[_loc3_] || typeof param1[_loc2_].start[_loc3_] == "number" && typeof param1[_loc2_].end[_loc3_] == "number" && Boolean(isNaN(param1[_loc2_].start[_loc3_])) && Boolean(isNaN(param1[_loc2_].end[_loc3_])))
               {
      ...
      public function resume() : void
      {
         var _loc1_:int = 0;
         var _loc2_:int = 0;
         if(Boolean(isPlaying) && Boolean(isPaused))
         {
            isPaused = false;
      ...
      protected function applyValueToTarget(param1:Object, param2:String, param3:*, param4:Object) : void
      {
         ...
         if(property in target)
         {
            try
            {
               if(Boolean(applyActualDimensions) && target is IFlexDisplayObject && property == "height")
               {
                  target.setActualSize(target.width,value);
               }
               else if(Boolean(applyActualDimensions) && target is IFlexDisplayObject && property == "width")
               {
