   ...
   public class EditTextWidget extends PopUpBase
   {
      ...
      override protected function commitProperties() : void
      {
         ...
         if(this.m_InvalidReadOnly)
         {
            ...
            {
               this.m_ReadOnly = !(Boolean(_loc2_.isWriteable) || Boolean(_loc2_.isWriteableOnce) && !_loc4_);
            }
            else
            {
         ...
         if(this.m_InvalidHeading)
         {
            ...
            if(this.m_ReadOnly)
            {
               ...
               else if(Boolean(_loc4_) && Boolean(_loc5_) && !_loc6_)
               {
            ...
            else if(Boolean(_loc4_) && Boolean(_loc5_) && Boolean(_loc6_))
            {
