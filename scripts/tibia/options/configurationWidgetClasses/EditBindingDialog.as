package tibia.options.configurationWidgetClasses
{
   ...
   public class EditBindingDialog extends EmbeddedDialog
   {
      ...
      override protected function commitProperties() : void
      {
         ...
         if(this.m_OldBinding != null && this.m_NewBinding != null && this.m_Mapping != null)
         {
            ...
            if(_loc3_)
            {
               for each(_loc2_ in this.m_Mapping)
               {
                  if(this.m_OldBinding != _loc2_.firstBinding && Boolean(this.m_NewBinding.conflicts(_loc2_.firstBinding)))
                  {
                     _loc4_ = Binding(_loc2_.firstBinding);
                     break;
                  }
                  if(this.m_OldBinding != _loc2_.secondBinding && Boolean(this.m_NewBinding.conflicts(_loc2_.secondBinding)))
                  {
               ...
               if(_loc4_ != null)
               {
                  _loc3_ = Boolean(Boolean(_loc4_.editable) && !_loc4_.action.equals(this.m_NewBinding.action));
               }
            }
            ...
            else if(_loc4_ != null && Boolean(_loc4_.action.equals(this.m_NewBinding.action)))
            {
      ...
      private function updateBinding(param1:Array, param2:Binding, param3:Binding) : void
      {
         ...
         {
            if(param2 != _loc4_.firstBinding && param3 != null && Boolean(param3.conflicts(_loc4_.firstBinding)) || param2 == _loc4_.firstBinding && param3 == null)
            {
               _loc4_.firstBinding = _loc4_.secondBinding;
               _loc4_.secondBinding = null;
            }
            if(param2 != _loc4_.secondBinding && param3 != null && Boolean(param3.conflicts(_loc4_.secondBinding)) || param2 == _loc4_.secondBinding && param3 == null)
            {
               _loc4_.secondBinding = null;
            }
         }
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(param2 == _loc4_.firstBinding || Boolean(_loc5_) && _loc4_.firstBinding == null)
            {
               _loc4_.firstBinding = param2;
               break;
            }
            if(param2 == _loc4_.secondBinding || Boolean(_loc5_) && _loc4_.secondBinding == null)
            {
