package mx.managers
{
   ...
   public class FocusManager implements IFocusManager
   {
      ...
      private function creationCompleteHandler(param1:FlexEvent) : void
      {
         ...
         if(Boolean(_loc2_.parent) && Boolean(_loc2_.visible) && !activated)
         {
      ...
      private function addFocusables(param1:DisplayObject, param2:Boolean = false) : void
      {
         ...
         if(o is mx.managers.IFocusManagerComponent && !skipTopLevel)
         {
            ...
            if(o is mx.managers.IFocusManagerComponent)
            {
               ...
               {
                  if(Boolean(focusable.tabEnabled) && Boolean(isTabVisible(o)))
                  {
      ...
      private function tabEnabledChangeHandler(param1:Event) : void
      {
         ...
         {
            if(_loc4_ == _loc3_ && Boolean(isTabVisible(_loc2_)))
            {
      ...
      private function mouseFocusChangeHandler(param1:FocusEvent) : void
      {
         ...
         if(param1.relatedObject is TextField)
         {
            ...
            if(_loc2_.type == "input" || Boolean(_loc2_.selectable))
            {
               return;
            }
         }
      ...
      private function getIndexOfFocusedObject(param1:DisplayObject) : int
      {
         ...
         while(_loc3_ < _loc2_)
         {
            ...
            if(Boolean(_loc4_) && Boolean(_loc4_.owns(param1)))
            {
               return _loc3_;
            }
            _loc3_++;
      ...
      private function removeFromParentBridge(param1:Event) : void
      {
         ...
         if(_loc2_.useSWFBridge())
         {
            ...
            if(Boolean(_loc3_) && !(form.systemManager is SystemManagerProxy))
            {
      ...
      private function mouseDownHandler(param1:MouseEvent) : void
      {
         ...
         {
            if(!_lastFocus && _loc3_ is IEventDispatcher && Boolean(SystemManager(form.systemManager).useSWFBridge()))
            {
      ...
      private function sortFocusableObjectsTabIndex() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            if(Boolean(_loc3_ && _loc3_.tabIndex) && Boolean(!isNaN(Number(_loc3_.tabIndex))) || focusableObjects[_loc2_] is ISWFLoader)
            {
      ...
      public function set defaultButton(param1:IButton) : void
      {
         ...
         if(_loc2_ != _defaultButton)
         {
            ...
            if(Boolean(_lastFocus) && Boolean(_lastFocus is IButton) && !(_lastFocus is IToggleButton))
            {
      ...
      private function setFocusToNextObject(param1:FocusEvent) : void
      {
         ...
         if(!popup && (Boolean(_loc2_.wrapped) || !_loc2_.displayObject))
         {
            if(getParentBridge())
            {
               moveFocusToParent(param1.shiftKey);
      ...
      private function getTopLevelFocusTarget(param1:InteractiveObject) : InteractiveObject
      {
         while(true)
         {
            ...
            {
               if(param1 is mx.managers.IFocusManagerComponent && Boolean(IFocusManagerComponent(param1).focusEnabled) && Boolean(IFocusManagerComponent(param1).mouseFocusEnabled) && (param1 is IUIComponent?Boolean(IUIComponent(param1).enabled):Boolean(true)))
               {
                  break;
               }
      ...
      private function removedHandler(param1:Event) : void
      {
         ...
         if(Boolean(_loc4_) && _loc3_ != focusPane)
         {
            if(_loc3_ is DisplayObjectContainer && Boolean(isParent(DisplayObjectContainer(_loc3_),focusPane)))
            {
      ...
      private function dispatchEventFromSWFBridges(param1:Event, param2:IEventDispatcher = null) : void
      {
         ...
         if(!popup)
         {
            ...
            if(Boolean(_loc7_) && _loc7_ != param2)
            {
               _loc3_ = param1.clone();
      ...
      public function set showFocusIndicator(param1:Boolean) : void
      {
         ...
         if(Boolean(_loc2_) && !popup && Boolean(form.systemManager.swfBridgeGroup))
         {
      ...
      private function setFocusToNextIndex(param1:int, param2:Boolean) : void
      {
         ...
         if(!popup && Boolean(_loc3_.wrapped))
         {
            if(getParentBridge())
            {
