package tibia.trade.npcTradeWidgetClasses
{
   ...
   public class CategorySelector extends Tile
   {
      ...
      private static function s_InitializeStyle() : void
      {
         ...
         {
            CategorySelector.backgroundSkin = null;
            CategorySelector.disabledSkin = null;
            CategorySelector.highlightSkin = null;
            CategorySelector.paddingBottom = 1;
            CategorySelector.paddingLeft = 1;
            CategorySelector.paddingRight = 1;
            CategorySelector.paddingTop = 1;
         };
         ...
         Decl.defaultFactory = function():void
         {
            CategorySelector.rendererStyle = "defaultCategoryAppearanceRendererStyle";
         };
         StyleManager.setStyleDeclaration(Selector,Decl,true);
      }
