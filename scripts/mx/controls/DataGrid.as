package mx.controls
{
    ...
    public class DataGrid extends DataGridBase implements IIMESupport
    {
        ...
        public function set editedItemPosition(param1:Object) : void
        {
            ...
            var _loc_2:* = {rowIndex:param1.rowIndex, columnIndex:param1.columnIndex};
        ...
        public function columnRendererChanged(param1:DataGridColumn) : void
        {
            var _loc_2:* = null;
        ...
        override protected function focusInHandler(event:FocusEvent) : void
        {
            ...
            if (editable && !isPressed)
            {
                ...
                while (_loc_4.columnIndex != _columns.length)
                {
                ...
                if (_loc_3)
                {
                    beginningEdit(_loc_4.columnIndex, _loc_4.rowIndex);
                }
            }
            return;
        }// end function
            ...
            if (event is CollectionEvent)
            {
                ...
                else if (_loc_3.kind == CollectionEventKind.ADD)
                {
                    if (editedItemPosition)
                    {
                        if (_loc_3.location <= editedItemPosition.rowIndex)
                        {
                            ...
                            if (inEndEdit)
                            {
                                _editedItemPosition = {columnIndex:_loc_2.columnIndex, rowIndex:Math.max(0, _loc_2.rowIndex + _loc_3.items.length)};
                            }
                            else if (itemEditorInstance)
                            {
                                _editedItemPosition = {columnIndex:_loc_2.columnIndex, rowIndex:Math.max(0, _loc_2.rowIndex + _loc_3.items.length)};
                ...
                else if (_loc_3.kind == CollectionEventKind.REMOVE)
                {
                    if (editedItemPosition)
                    {
                        ...
                        else if (_loc_3.location <= _loc_2.rowIndex)
                        {
                            _loc_2 = editedItemPosition;
                            if (_loc_3.location == _loc_2.rowIndex && itemEditorInstance)
                            {
                                endEdit(DataGridEventReason.CANCELLED);
                            }
                            if (inEndEdit)
        ...
        private function calculateColumnSizes() : void
        {
                ...
                if (displayWidth > _loc_11 && _loc_10)
                {
                    ...
                    while (_loc_3 < _loc_2)
                    {
                        ...
                        if (visibleLockedColumns[_loc_3].resizable && !visibleLockedColumns[_loc_3].newlyVisible && isNaN(visibleLockedColumns[_loc_3].explicitWidth))
                        {
                            ...
                            _loc_14 = _loc_7.minWidth;
                            _loc_7.setWidth(_loc_8 > _loc_14 ? (_loc_8) : (_loc_14));
                        }
                        _loc_13 = _loc_13 - _loc_7.width;
                        _loc_7.newlyVisible = false;
                        _loc_3++;
                    }
                    _loc_2 = visibleColumns.length;
                    _loc_3 = 0;
            ...
            else
            {
                ...
                while (_loc_3 < _loc_2)
                {
                    ...
                    _loc_4 = _loc_4 + (isNaN(_loc_7.explicitWidth) ? (_loc_7.preferredWidth) : (_loc_7.explicitWidth));
                    _loc_3++;
                }
                if (visibleColumns.length == 0)
                {
        ...
        override protected function configureScrollBars() : void
        {
            ...
            if ((!verticalScrollBar || !_loc_3.visible) && collection && collection.length - lockedRowCount > _loc_4)
            {
                maxVerticalScrollPosition = collection.length - lockedRowCount - _loc_4;
            }
            if ((!horizontalScrollBar || !_loc_2.visible) && displayableColumns.length - lockedColumnCount > _loc_8 - lockedColumnCount)
            {
        ...
        protected function drawColumnBackground(param1:Sprite, param2:int, param3:uint, param4:DataGridColumn) : void
        {
            ...
            var _loc_9:* = (_loc_8).rendererArray[param2].x;
        ...
        private function commitEditedItemPosition(param1:Object) : void
        {
            ...
            _loc_6.columnIndex = displayableColumns[_loc_3].colNum;
