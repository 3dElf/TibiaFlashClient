package tibia.creatures.selectOutfitWidgetClasses
{
   ...
   public class OutfitColourSelector extends UIComponent
   {
      ...
      private static function s_InitializeStyle() : void
      {
         ...
         {
            OutfitColourSelector.pickerSize = 12;
            OutfitColourSelector.horizontalGap = 2;
            OutfitColourSelector.verticalGap = 2;
            OutfitColourSelector.paddingLeft = 0;
            OutfitColourSelector.paddingRight = 0;
            OutfitColourSelector.paddingTop = 0;
            OutfitColourSelector.paddingBottom = 0;
         };
