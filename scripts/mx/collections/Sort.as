package mx.collections
{
   ...
   public class Sort extends EventDispatcher
   {
      ...
      public function propertyAffectsSort(param1:String) : Boolean
      {
         ...
         if(Boolean(usingCustomCompareFunction) || !fields)
         {
            return true;
         }
         var _loc2_:int = 0;
         while(_loc2_ < fields.length)
         {
            ...
            if(_loc3_.name == param1 || Boolean(_loc3_.usingCustomCompareFunction))
            {
               return true;
            }
            _loc2_++;
