package tibia.sessiondump.controller
{
   ...
   public class SessiondumpControllerBase implements ISessiondumpRemoteControl
   {
      ...
      public static const PROTOCOL_VERSION:int = 1077;
      ...
      protected function processPackets() : void
      {
         ...
         if(Boolean(this.m_Sessiondump.sessiondumpDone) || Boolean(this.m_SuspendProcessingOfMessages))
         {
            return;
         }
         this.measureRealPlaybackSpeed();
         if(this.m_SessiondumpReader != null && Boolean(this.m_SessiondumpReader.isPacketReady))
         {
            _loc1_ = true;
            ...
            while(_loc1_)
            {
               ...
               else if(Boolean(this.isGameRunning) && getTimer() - Tibia.s_FrameRealTimestamp > this.m_YieldMessageProcessingAfterMilliseconds)
               {
                  _loc1_ = false;
               ...
               if(_loc1_)
               {
                  ...
                  if(this.m_Sessiondump == null || Boolean(_loc5_))
                  {
                     _loc1_ = false;
                     this.synchronizeSessiondumpTimeWithTibiaTime(_loc2_);
                  }
                  ...
                  if(this.m_Sessiondump != null && Boolean(this.m_Sessiondump.isConnected))
                  {
         ...
         if(this.m_Sessiondump != null && (!this.m_Sessiondump.isConnected || Boolean(this.m_Sessiondump.sessiondumpDone)))
         {
            this.synchronizeSessiondumpTimeWithTibiaTime(_loc2_);
