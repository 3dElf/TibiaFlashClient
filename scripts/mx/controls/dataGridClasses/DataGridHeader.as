    ...
    public class DataGridHeader extends DataGridHeaderBase
    {
        ...
        protected function mouseUpHandler(event:MouseEvent) : void
        {
            ...
            else
            {
                ...
                while (_loc_6 < headerItems.length)
                {
                    ...
                    if (_loc_3.x + _loc_3.width >= _loc_7.x)
                    {
                        _loc_3 = headerItems[_loc_6];
                        break;
                    }
        ...
        protected function drawSeparators() : void
        {
            ...
            while (_loc_3 < _loc_2)
            {
                ...
                {
                    _loc_4.visible = true;
                    _loc_4.x = headerItems[_loc_3].x + _loc_6[_loc_3].width - Math.round(_loc_5.measuredWidth / 2);
                    if (_loc_3 > 0)
                    {
            ...
            if (dataGrid.enabled && dataGrid.sortableColumns && dataGrid.headerVisible)
            {
                ...
                else
                {
                    ...
                    while (_loc_3 < headerItems.length)
                    {
                        ...
                        if (_loc_2.x + _loc_2.width >= _loc_5.x)
                        {
                            _loc_2 = headerItems[_loc_3];
                            break;
                        }
        ...
        private function columnResizeMouseDownHandler(event:MouseEvent) : void
        {
            ...
            _loc_7.addEventListener(MouseEvent.MOUSE_MOVE, columnResizingHandler, true);
            ...
            resizeGraphic.move(_loc_2.x + x, 0);
        ...
        private function columnDraggingMouseUpHandler(event:Event) : void
        {
            ...
            _loc_4.removeEventListener(MouseEvent.MOUSE_MOVE, columnDraggingMouseMoveHandler, true);
            ...
            while (_loc_5 < _loc_6)
            {
                ...
                if (_loc_10.x < _loc_11 + _loc_12)
                {
                    ...
                    if (dropColumnIndex != _loc_5)
                    {
                        ...
                        _loc_17.x = _loc_13.left;
                        _loc_17.y = _loc_13.top;
                        _loc_17.width = dataGrid.width / dataGrid.scaleX - _loc_17.x - _loc_13.right;
                        _loc_17.height = dataGrid.height / dataGrid.scaleY - _loc_17.x - _loc_13.bottom;
        ...
        public function clearSelectionLayer() : void
        {
        ...
        private function columnResizeMouseUpHandler(event:Event) : void
        {
            ...
            _loc_8.columnIndex = _loc_3.colNum;
        ...
        protected function mouseDownHandler(event:MouseEvent) : void
        {
            ...
            else
            {
                ...
                while (_loc_4 < headerItems.length)
                {
                    ...
                    if (_loc_2.x + _loc_2.width >= _loc_6.x)
                    {
                        _loc_2 = headerItems[_loc_4];
                        break;
                    }
        ...
        protected function drawHeaderBackground(param1:UIComponent) : void
        {
            ...
            _loc_6.createGradientBox(_loc_2, (_loc_3 + 1), Math.PI / 2, 0, 0);
