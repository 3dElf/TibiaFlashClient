package tibia.sessiondump.hints.condition
{
    ...
    public class HintConditionMove extends HintConditionBase
    {
        ...
        public static function s_Unmarshall(param1:Object) : HintConditionMove
        {
            ...
            {
                _loc_2 = new HintConditionMove;
                _loc_2.m_SourceAbsolute = HintConditionBase.s_UnmarshallCoordinate(param1[FIELD_SOURCE_COORDINATE]);
                _loc_2.m_ObjectTypeID = param1[FIELD_OBJECTTYPEID] as int;
                _loc_2.m_ObjectAmount = param1[FIELD_AMOUNT] as int;
                _loc_2.m_DestAbsolute = HintConditionBase.s_UnmarshallCoordinate(param1[FIELD_DESTINATION_COORDINATE]);
                return _loc_2;
            }
