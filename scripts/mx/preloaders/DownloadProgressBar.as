package mx.preloaders
{
   ...
   public class DownloadProgressBar extends Sprite implements IPreloaderDisplay
   {
      ...
      protected function progressHandler(param1:ProgressEvent) : void
      {
         ...
         if(Boolean(_showingDisplay) || Boolean(showDisplayForDownloading(_loc4_,param1)))
         {
            if(!_startedLoading)
            {
               show();
      ...
      protected function initProgressHandler(param1:Event) : void
      {
         ...
         _initProgressCount++;
         if(!_showingDisplay && Boolean(showDisplayForInit(_loc2_,_initProgressCount)))
         {
      ...
      private function initCompleteHandler(param1:Event) : void
      {
         ...
         if(Boolean(_showingDisplay) && _loc2_ < MINIMUM_DISPLAY_TIME)
         {
      ...
      {
         if(!_visible && Boolean(param1))
         {
            show();
         }
         else if(Boolean(_visible) && !param1)
         {
            hide();
         }
         _visible = param1;
