package tibia.sessiondump.hints.condition
{
    ...
    public class HintConditionUse extends HintConditionBase
    {
        ...
        public static function s_Unmarshall(param1:Object) : HintConditionUse
        {
            ...
            {
                _loc_2 = new HintConditionUse;
                _loc_2.m_Absolute = HintConditionBase.s_UnmarshallCoordinate(param1[FIELD_COORDINATE]);
                _loc_2.m_UseTypeID = param1[FIELD_USE_TYPE_ID] as int;
                _loc_2.m_PositionOrData = param1[FIELD_POSITION] as int;
                _loc_2.m_UseTarget = param1[FIELD_TARGET] as int;
                if (FIELD_MULTIUSE_TARGET in param1)
                {
                    _loc_2.m_MultiuseTarget = HintConditionBase.s_UnmarshallCoordinate(param1[FIELD_MULTIUSE_TARGET]);
                    _loc_2.m_MultiuseObjectID = param1[FIELD_MULTIUSE_OBJECT_ID] as int;
                    _loc_2.m_MultiuseObjectPosition = param1[FIELD_MULTIUSE_OBJECT_POSITION] as int;
                }
                return _loc_2;
            }
            else
